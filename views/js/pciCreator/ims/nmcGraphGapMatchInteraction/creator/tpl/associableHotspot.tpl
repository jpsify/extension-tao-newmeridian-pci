...
<div class="panel">
    <label>
        {{__ 'Alternate text'}}
        <span class="icon-help tooltipstered" data-tooltip="~ .tooltip-content:first" data-tooltip-theme="info"></span>
        <div class="tooltip-content">{{__ "Alternate text for gap"}}</div>
...
<div class="panel">
    <label>
        {{__ 'Group ID'}}
        <span class="icon-help tooltipstered" data-tooltip="~ .tooltip-content:first" data-tooltip-theme="info"></span>
        <div class="tooltip-content">{{__ "The group identifier of the gap"}}</div>
        <input type="text" name="groupId" value="{{groupId}}">
    </label>
</div>

<div class="panel shape-position">
    ...
    <div class="panel">
        <label>
            ...
            <input name="x" value="{{x}}" type="text" data-increment="1" data-min="1" class="incrementer" />
        </label>
    </div>
    ...
    <div class="panel">
        <label>
            ...
            <input name="y" value="{{y}}" type="text" data-increment="1" data-min="1" class="incrementer" />
        </label>
    </div>
    ...
    <div class="panel">
        <label>
            ...
            <input name="width" value="{{width}}" type="text" data-increment="1" data-min="1" class="incrementer" />
        </label>
    </div>
    ...
    <div class="panel">
        <label>
            ...
            <input name="height" value="{{height}}" type="text" data-increment="1" data-min="1" class="incrementer" />
        </label>
    </div>
</div>
