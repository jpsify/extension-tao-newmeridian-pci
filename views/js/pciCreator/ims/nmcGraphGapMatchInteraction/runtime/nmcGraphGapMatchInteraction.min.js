...
},type,chainable?margin:void 0,chainable,null)}})}),jQuery.fn.size=function(){return this.length},jQuery.fn.andSelf=jQuery.fn.addBack;var _jQuery=window.jQuery,_$=window.$;return jQuery.noConflict=function(deep){return window.$===jQuery&&(window.$=_$),deep&&window.jQuery===jQuery&&(window.jQuery=_jQuery),jQuery},void 0===noGlobal&&(window.jQuery=window.$=jQuery),jQuery}),jQuery.noConflict(!0)}),define("taoQtiItem/portableLib/handlebars",[],function(){return function(){var __module4__=function(){"use strict";function SafeString(string){this.string=string}return SafeString.prototype.toString=function(){return""+this.string},SafeString
...
},badChars=/[&<>"'`]/g,possible=/[&<>"'`]/;__exports__.extend=extend;var toString=Object.prototype.toString;__exports__.toString=toString;var isFunction=function(value){return"function"==typeof value};isFunction(/x/)&&(isFunction=function(value){return"function"==typeof value&&"[object Function]"===toString.call(value)});var isFunction;__exports__.isFunction=isFunction;var isArray=Array.isArray||function(value){return!(!value||"object"!=typeof value)&&"[object Array]"===toString.call(value)};return __exports__.isArray=isArray,__exports__.escapeExpression=escapeExpression,__exports__.isEmpty=isEmpty,__exports__}(__module4__),__module5__=function(){
"use strict";function Exception(message,node){var line;node&&node.firstLine&&(line=node.firstLine,message+=" - "+line+":"+node.firstColumn);for(var tmp=Error.prototype.constructor.call(this,message),idx=0;idx<errorProps.length;idx++)this[errorProps[idx]]=tmp[errorProps[idx]];line&&(this.lineNumber=line,this.column=node.firstColumn)}var errorProps=["description","fileName","lineNumber","message","name","number","stack"];return Exception.prototype=new Error,Exception}(),__module2__=function(__dependency1__,__dependency2__){"use strict";function HandlebarsEnvironment(helpers,partials){this.helpers=helpers||{},this.partials=partials||{},
...
hb.precompile=function(input,options){return precompile(input,options,hb)},hb.AST=AST,hb.Compiler=Compiler,hb.JavaScriptCompiler=JavaScriptCompiler,hb.Parser=Parser,hb.parse=parse,hb};return Handlebars=create(),Handlebars.create=create,Handlebars}(__module1__,__module7__,__module8__,__module10__,__module11__)}()}),define("nmcGraphGapMatchInteraction/runtime/js/Graphic",["jquery","lodash","raphael","scale.raphael"],function($,_,raphael,scaleRaphael){"use strict";function _interopDefaultLegacy(e){return e&&"object"==typeof e&&"default"in e?e:{default:e}}
var $__default=_interopDefaultLegacy($),___default=_interopDefaultLegacy(_),raphael__default=_interopDefaultLegacy(raphael),scaleRaphael__default=_interopDefaultLegacy(scaleRaphael),basic={stroke:"#8D949E","stroke-width":2,"stroke-dasharray":"","stroke-linejoin":"round",fill:"#cccccc","fill-opacity":.5,cursor:"pointer"},hover={stroke:"#3E7DA7",fill:"#0E5D91","fill-opacity":.3},selectable={"stroke-dasharray":"-",stroke:"#3E7DA7",fill:"#cccccc","fill-opacity":.5},active={stroke:"#3E7DA7","stroke-dasharray":"",fill:"#0E5D91","fill-opacity":.5},error={stroke:"#C74155","stroke-dasharray":"","fill-opacity":.5,fill:"#661728"},success={stroke:"#C74155",
"stroke-dasharray":"",fill:"#0E914B","fill-opacity":.5},layer={fill:"#ffffff",opacity:0,cursor:"pointer"},creator={"fill-opacity":.5,stroke:"#3E7DA7","stroke-dasharray":"",fill:"#0E5D91",cursor:"pointer"},target={
...
fill:"#0E914B",width:1,"stroke-width":0,cursor:"pointer"},assoc={"stroke-width":2,"stroke-linecap":"round",cursor:"pointer"},close={
...
fill:"#0E5D91",width:1,opacity:0,"stroke-width":0,cursor:"pointer"},gstyle={basic:basic,hover:hover,selectable:selectable,active:active,error:error,success:success,layer:layer,creator:creator,"imageset-rect-stroke":{fill:"#ffffff",stroke:"#666666","stroke-width":1,"stroke-linejoin":"round",cursor:"pointer"},"imageset-rect-no-stroke":{fill:"#ffffff",stroke:"#ffffff","stroke-width":2,"stroke-linejoin":"round",cursor:"pointer"},"imageset-img":{cursor:"pointer"},"order-text":{fill:"#ffffff",stroke:"#000000","stroke-width":.7,"font-family":"sans-serif","font-weight":"bold","font-size":22,cursor:"pointer"},"score-text-default":{stroke:"#444444","stroke-width":.5,
"font-family":"sans-serif","font-weight":"normal","font-size":20,cursor:"pointer"},"score-text":{stroke:"#000000","stroke-width":.5,"font-family":"sans-serif","font-weight":"normal","font-size":20,cursor:"pointer"},"small-text":{stroke:"#000000","stroke-width":.5,"font-family":"sans-serif","font-weight":"normal","font-size":16,cursor:"pointer"},"layer-pos-text":{stroke:"#333","stroke-width":.5,"font-family":"sans-serif","font-weight":"normal","font-size":14},target:target,"target-hover":{fill:"#3E7DA7","fill-opacity":1},"target-success":{fill:"#0E914B","fill-opacity":1},assoc:assoc,"assoc-layer":{"stroke-width":12,cursor:"pointer","stroke-opacity":0},
"assoc-bullet":{fill:"#000000"},close:close,"close-bg":{fill:"#ffffff",stroke:"none",cursor:"pointer",opacity:0},"touch-circle":{fill:"none",stroke:"#3E7DA7","stroke-width":2}},shapeMap={default:"rect",poly:"path"},coordsValidator={rect:4,ellipse:4,circle:3,poly:6,default:0},qti2raphCoordsMapper={rect:function(coords){return[coords[0],coords[1],coords[2]-coords[0],coords[3]-coords[1]]},default:function(paper){return[0,0,paper.width,paper.height]},poly:function(coords){var a,size=coords.length;for(coords[0]!==coords[size-2]&&coords[1]!==coords[size-1]&&(coords.push(coords[0]),coords.push(coords[1])),coords[0]="M"+coords[0],
a=1;a<size;a++)a%2==0&&(coords[a]="L"+coords[a]);return[coords.join(" ")]}},raph2qtiCoordsMapper={rect:function(attr){return[attr.x,attr.y,attr.x+attr.width,attr.y+attr.height]},circle:function(attr){return[attr.cx,attr.cy,attr.r]},ellipse:function(attr){return[attr.cx,attr.cy,attr.rx,attr.ry]},default:function(attr){return this.rect(attr)},path:function(attr){var i,poly=[];if(___default.default.isArray(attr.path))for(i=1;i<attr.path.length;i++)3===attr.path[i].length&&(poly.push(attr.path[i][1]),poly.push(attr.path[i][2]));return poly}};return{_style:gstyle,setStyle:function(element,name){element&&gstyle[name]&&element.attr(gstyle[name])},
responsivePaper:function(id,serial,options){function resizePaper(e,givenWidth){var diff,maxWidth,containerWidth,containerHeight,factor;e&&e.stopPropagation(),diff=$editor.outerWidth()-$editor.width()+($container.outerWidth()-$container.width())+1,maxWidth=$body.width(),((containerWidth=$container.innerWidth())>0||givenWidth>0)&&(givenWidth<containerWidth&&givenWidth<maxWidth?containerWidth=givenWidth-diff:containerWidth>maxWidth?containerWidth=maxWidth-diff:containerWidth-=diff,factor=containerWidth/imgWidth,containerHeight=imgHeight*factor,containerWidth>0&&paper.changeSize(containerWidth,containerHeight,!1,!1),
"function"==typeof options.resize&&options.resize(containerWidth,factor),$container.trigger("resized.qti-widget"))}var paper,image,$container=options.container||$__default.default("#"+id).parent(),$editor=$__default.default(".image-editor",$container),$body=$container.closest(".qti-itemBody"),resizer=___default.default.throttle(resizePaper,10),containerWidth=$container.innerWidth(),containerHeight=$container.innerHeight(),imgWidth=options.width||containerWidth,imgHeight=options.height||containerHeight;return paper=scaleRaphael__default.default(id,imgWidth,imgHeight),paper.changeSize(containerWidth,containerHeight,!1,!1),
image=paper.image(options.img,0,0,imgWidth,imgHeight),image.id=options.imgId||image.id,paper.setViewBox(0,0,imgWidth,imgHeight),resizer(),$__default.default(image.node).attr("externalResourcesRequired","true").on("load",resizer),"SVG"===raphael__default.default.type?($__default.default(window).on("resize.qti-widget."+serial,resizer),$container.on("resize.qti-widget."+serial,resizer),$__default.default(document).on("customcssloaded.styleeditor",resizer)):($container.find(".main-image-box").width(imgWidth),"function"==typeof options.resize&&options.resize(imgWidth,1)),paper},createElement:function(paper,type,coords,options){
var element,self=this,shaper=shapeMap[type]?paper[shapeMap[type]]:paper[type],shapeCoords=!1!==options.qtiCoords?self.raphaelCoords(paper,type,coords):coords;if("function"!=typeof shaper)throw new Error("Unable to find method "+type+" on paper");return(element=shaper.apply(paper,shapeCoords))&&(options.id&&(element.id=options.id),options.title&&element.attr("title",options.title),element.attr(gstyle[options.style||"basic"]).toFront(),$__default.default(element.node).removeAttr("stroke-dasharray"),!1!==options.hover&&element.hover(function(){element.flashing||self.updateElementState(this,"hover")},function(){
element.flashing||self.updateElementState(this,this.active?"active":this.selectable?"selectable":"basic")}),!1!==options.touchEffect&&element.touchstart(function(){self.createTouchCircle(paper,element.getBBox())})),element},createTarget:function(paper,options){var baseSize,count,factor,half,hover,layer,point,self,tBBox,targetSize,x,y,target;return options=options||{},self=this,point=options.point||{x:0,y:0},factor=0!==paper.w?paper.width/paper.w:1,hover=void 0===options.hover||!!options.hover,baseSize=18,half=baseSize/2,x=point.x-half,y=point.y-half,targetSize=0!==factor?2/factor:2,
target=paper.path(gstyle.target.path).transform("t"+x+","+y+"s"+targetSize).attr(gstyle.target).attr("title",___default.default("Click again to remove")),options.id?target.id=options.id:(count=0,paper.forEach(function(element){element.data("target")&&count++}),target.id="target-"+count),tBBox=target.getBBox(),layer=paper.rect(tBBox.x,tBBox.y,tBBox.width,tBBox.height).attr(gstyle.layer).click(function(){var id=target.id,p=this.data("point");___default.default.isFunction(options.select)&&options.select(target,p,this),___default.default.isFunction(options.remove)&&(this.remove(),target.remove(),options.remove(id,p))}),hover&&layer.hover(function(){
target.flashing||self.setStyle(target,"target-hover")},function(){target.flashing||self.setStyle(target,"target-success")}),layer.id="layer-"+target.id,layer.data("point",point),target.data("target",point),___default.default.isFunction(options.create)&&options.create(target),target},raphaelCoords:function(paper,type,coords){var shapeCoords;if(___default.default.isString(coords)&&(coords=___default.default.map(coords.split(","),function(coord){return parseInt(coord,10)})),!___default.default.isArray(coords)||coords.length<coordsValidator[type])throw new Error("Invalid coords "+JSON.stringify(coords)+"  for type "+type);switch(type){case"rect":
shapeCoords=qti2raphCoordsMapper.rect(coords);break;case"default":shapeCoords=qti2raphCoordsMapper.default.call(null,paper);break;case"poly":shapeCoords=qti2raphCoordsMapper.poly(coords);break;default:shapeCoords=coords}return shapeCoords},qtiCoords:function(element){var mapper=raph2qtiCoordsMapper[element.type],result="";return ___default.default.isFunction(mapper)&&(result=___default.default.map(mapper.call(raph2qtiCoordsMapper,element.attr()),function(coord){return ___default.default.parseInt(coord)}).join(",")),result},createTouchCircle:function(paper,bbox){
var radius=bbox.width>bbox.height?bbox.width:bbox.height,tCircle=paper.circle(bbox.x+bbox.width/2,bbox.y+bbox.height/2,radius);tCircle.attr(gstyle["touch-circle"]),___default.default.defer(function(){tCircle.animate({r:radius+5,opacity:.7},300,function(){tCircle.remove()})})},createText:function(paper,options){var fontSize,scaledFontSize,text,top=options.top||0,left=options.left||0,content=options.content||"",style=options.style||"small-text",title=options.title||"",factor=1;return paper.width&&paper.w&&(factor=paper.width/paper.w),text=paper.text(left,top,content).toFront(),options.id&&(text.id=options.id),options.hide&&text.hide(),text.attr(gstyle[style]),
void 0!==factor&&1!==factor&&(fontSize=parseInt(text.attr("font-size"),10),scaledFontSize=Math.floor(fontSize/factor)+1,text.attr("font-size",scaledFontSize)),title&&this.updateTitle(text,title),text},createShapeText:function(paper,shape,options){var self=this,bbox=shape.getBBox(),text=this.createText(paper,___default.default.merge({left:bbox.x+bbox.width/2,top:bbox.y+bbox.height/2},options));return options.shapeClick&&text.click(function(){self.trigger(shape,"click")}),text},createBorderedImage:function(paper,options){
var padding=options.padding>=0?options.padding:6,halfPad=padding/2,rx=options.left,ry=options.top,rw=options.width+padding,rh=options.height+padding,ix=options.left+halfPad,iy=options.top+halfPad,iw=options.width,ih=options.height,set=paper.set(),rect=paper.rect(rx,ry,rw,rh).attr(options.border?gstyle["imageset-rect-stroke"]:gstyle["imageset-rect-no-stroke"]),image=paper.image(options.url,ix,iy,iw,ih).attr(gstyle["imageset-img"]);return options.shadow&&set.push(rect.glow({width:2,offsetx:1,offsety:1})),set.push(rect,image),set.move=function(x,y,duration){var animation=raphael__default.default.animation({x:x,y:y},duration||400),elt=rect.animate(animation)
;return image.animateWith(elt,animation,{x:x+halfPad,y:y+halfPad},duration||400),set},set},updateElementState:function(element,state,title){element&&element.animate&&(element.animate(gstyle[state],200,"linear",function(){element.attr(gstyle[state]),$__default.default(element.node).removeAttr("stroke-dasharray")}),title&&this.updateTitle(element,title))},updateTitle:function(element,title){element&&element.node&&(___default.default.forEach(element.node.children,function(child){"title"===child.nodeName.toLowerCase()&&element.node.removeChild(child)}),element.attr("title",title))},highlightError:function(element,restoredState){var self=this
;element&&(element.flashing=!0,self.updateElementState(element,"error"),___default.default.delay(function(){self.updateElementState(element,restoredState||"basic"),element.flashing=!1},800))},trigger:function(element,event){var evt=___default.default.where(element.events,{name:event});evt.length&&evt[0]&&"function"==typeof evt[0].f&&evt[0].f.apply(element,Array.prototype.slice.call(arguments,2))},getPoint:function(event,paper,$container){var point=this.clickPoint($container,event),rect=$container.get(0).getBoundingClientRect(),factor=paper.w/rect.width;return point.x=Math.round(point.x*factor),point.y=Math.round(point.y*factor),point},
position:function($container,paper){var pw=parseInt(paper.w||paper.width,10),cw=parseInt($container.width(),10),ph=parseInt(paper.w||paper.width,10);return{left:(cw-pw)/2,top:(parseInt($container.height(),10)-ph)/2}},clickPoint:function($container,event){var x,y,offset=$container.offset();return event.pageX||event.pageY?(x=event.pageX-offset.left,y=event.pageY-offset.top):(event.clientX||event.clientY)&&(x=event.clientX+document.body.scrollLeft+document.documentElement.scrollLeft-offset.left,y=event.clientY+document.body.scrollTop+document.documentElement.scrollTop-offset.top),{x:x,y:y}}}}),
define("css!nmcGraphGapMatchInteraction/runtime/css/nmcGraphGapMatchInteraction",[],function(){}),define("nmcGraphGapMatchInteraction/runtime/js/renderer",["taoQtiItem/portableLib/jquery_2_1_1","taoQtiItem/portableLib/lodash","taoQtiItem/portableLib/handlebars","nmcGraphGapMatchInteraction/runtime/js/Graphic","taoQtiItem/qtiCreator/helper/dummyElement","css!nmcGraphGapMatchInteraction/runtime/css/nmcGraphGapMatchInteraction"],function($,_,Handlebars,graphic,dummyElement){"use strict";var fixMarkupMediaSources=function(html,renderer){return html=html||"",html.replace(/(<img[^>]*src=["'])([^"']+)(["'])/gi,function(substr,$1,$2,$3){
return $1+(renderer.resolveUrl($2)||$2)+$3})};return function(options){var self=this,defaultOptions={state:"sleep",templates:{},serial:"",width:300,height:300};this.backgroundImage=void 0,this.options={},this.$gapList=null,this.init=function(){var gapTpl;_.assign(self.options,defaultOptions,options),gapTpl=$(".gap-match-gaps-tpl").html().replace("<![CDATA[","").replace("]]>",""),self.options.templates.gaps=Handlebars.compile(gapTpl)},this.onResize=function(width,factor){self.$gapList&&(self.$gapList.css("max-width",width+"px"),1!==factor&&self.$gapList.find("img").each(function(){var $img=$(this);$img.width($img.attr("width")*factor),
$img.height($img.attr("height")*factor)}),self.options.$container.data("factor",factor))},this.renderBackground=function(img,width,height,altText,renderer){var bgImg,fixedImg=fixMarkupMediaSources(img,renderer),$img=$(fixedImg);if($img.length){var src=$img[0].getAttribute("src"),imgWidth=width||self.options.width,imgHeight=height||self.options.height,serial=self.options.interaction.serial,$imgContainer=$(".image-container",self.options.$container),paper=graphic.responsivePaper($(".main-image-box",self.options.$container)[0],serial,{width:imgWidth,height:imgHeight,img:src,imgId:"bg-image-"+serial,container:$imgContainer,resize:this.onResize})
;paper.desc.remove(),altText&&(bgImg=paper.getById("bg-image-"+serial),bgImg[0].setAttribute("alt",altText),this._createDesc(paper,altText)),self.options.interaction.paper=paper}},this._createDesc=function(paper,altText){var desc=document.createElementNS("http://www.w3.org/2000/svg","desc");desc.style.webkitTapHighlightColor="rgba(0,0,0,0)",desc.appendChild(document.createTextNode(altText)),paper.canvas.appendChild(desc)},this._createPlaceholder=function(){
var $container=$(".image-container",self.options.$container),$imageBox=$container.find(".main-image-box"),$editor=$container.find(".image-editor"),diff=$editor.outerWidth()-$editor.width()+($container.outerWidth()-$container.width())+1;dummyElement.get({icon:"image",css:{width:$container.innerWidth()-diff,height:200},title:"Select an image first."}).click(function(){var $upload=$('[data-role="upload-trigger"]',self.$form);$upload.length&&$upload.trigger("click")}).appendTo($imageBox)},this.renderChoices=function(){_.forEach(self.options.interaction.getChoices(),function(choice){
var el=graphic.createElement(self.options.interaction.paper,choice.attributes.shape,choice.attributes.coords,{id:choice.serial,touchEffect:!1}).data("max",parseInt(choice.attributes.matchMax,10)).data("matching",[]).data("fillers",[]).data("groupId",choice.attributes.groupId);choice.attributes.altText&&(el[0].setAttribute("alt",choice.attributes.altText),self._createDesc(self.options.interaction.paper,choice.attributes.altText))})},this.renderGaps=function(renderer){var gaps=self.options.interaction.prop("gaps")||[];self.$gapList=self.options.$container.find("ul.source"),_.forEach(gaps,function(gap){
var $addOption,gapData=_.clone(gap),fixedImg=fixMarkupMediaSources(gapData.data,renderer),$img=$(fixedImg);$img.length&&(gapData.imgPath=self.options.interaction.renderer.resolveUrl($img[0].getAttribute("src")),gapData.objectLabel=gap.altText,$addOption=$(self.options.templates.gaps(gapData)),$addOption.appendTo(self.$gapList))})},this.render=function(data,skipGaps){return self.backgroundImage!==data.backgroundImage&&(self.backgroundImage=data.backgroundImage,self.paper&&self.paper.clear(),this.setGapPosition(data.position),data.backgroundImage?(skipGaps||this.renderGaps(self.options.interaction.renderer),
this.renderBackground(data.backgroundImage,data.width,data.height,data.altText,self.options.interaction.renderer),this.renderChoices()):(skipGaps||this.renderGaps(self.options.interaction.renderer),this._createPlaceholder())),this},this.setGapPosition=function(position){var $interaction=$(".nmc-graph-gap-match-interaction",self.options.$container),$gaps=$(".block-listing",self.options.$container);switch($interaction.length||($interaction=self.options.$container),$interaction.removeClass(function(index,className){return(className.match(/(^|\s)gap-position-\S+/g)||[]).join(" ")}),position){case"top":$interaction.addClass("gap-position-top"),
$gaps.addClass("horizontal");break;case"left":$interaction.addClass("gap-position-left"),$gaps.removeClass("horizontal");break;case"right":$interaction.addClass("gap-position-right"),$gaps.removeClass("horizontal");break;default:$interaction.addClass("gap-position-bottom"),$gaps.addClass("horizontal")}},this.init()}}),
define("nmcGraphGapMatchInteraction/runtime/js/nmcGraphGapMatchInteraction",["qtiCustomInteractionContext","jquery","lodash","taoQtiItem/portableLib/OAT/util/event","nmcGraphGapMatchInteraction/runtime/js/renderer","nmcGraphGapMatchInteraction/runtime/js/Graphic","taoQtiItem/qtiCommonRenderer/helpers/container","taoQtiItem/qtiCommonRenderer/helpers/instructions/instructionManager","interact","ui/interactUtils","css!nmcGraphGapMatchInteraction/runtime/css/nmcGraphGapMatchInteraction"],function(qtiCustomInteractionContext,$,_,event,Renderer,graphic,containerHelper,instructionMgr,interact,interactUtils){
var activeDrop=null,_isMatchable=function(element,groupId){var matching,matchMax,group,matchable=!1;return element&&(matchMax=element.data("max")||0,matching=element.data("matching")||[],group=element.data("groupId")||"",matchable=(0===matchMax||matchMax>matching.length)&&group===(groupId||"")),matchable},_shapesSelectable=function(interaction,groupId){var tooltip="Select the area to add an image";_.forEach(interaction.getChoices(),function(choice){var element=interaction.paper.getById(choice.serial);_isMatchable(element,groupId)&&(element.selectable=!0,graphic.setStyle(element,"selectable"),graphic.updateTitle(element,tooltip))}),
_.forEach(interaction.gapFillers,function(gapFiller){gapFiller.forEach(function(element){graphic.updateTitle(element,tooltip)})})},_shapesUnSelectable=function(interaction){_.forEach(interaction.getChoices(),function(choice){var element=interaction.paper.getById(choice.serial);element&&(element.selectable=!1,graphic.setStyle(element,"basic"),graphic.updateTitle(element,"Select an image first"))}),_.forEach(interaction.gapFillers,function(gapFiller){gapFiller.forEach(function(element){graphic.updateTitle(element,"Remove")})})},_iFrameDragFix=function(draggableSelector,target){interactUtils.iFrameDragFixOn(function(){activeDrop&&interact(activeDrop).fire({
type:"drop",target:activeDrop,relatedTarget:target}),interact(draggableSelector).fire({type:"dragend",target:target})})},_renderChoice=function(interaction,choice){function handleShapeSelect(groupId){_isMatchable(rElement,groupId)&&!0===rElement.selectable&&_selectShape(interaction,rElement)}var rElement=interaction.paper.getById(choice.serial);interact(rElement.node).on("tap",function(){document.getElementsByClassName("prevent-click-handler").length||handleShapeSelect()}),interact(rElement.node).dropzone({overlap:.15,ondragenter:function(e){_isMatchable(rElement,e.relatedTarget.dataset.groupid)&&(graphic.setStyle(rElement,"hover"),activeDrop=rElement.node)
},ondrop:function(e){var groupId=e.relatedTarget.dataset.groupid;_isMatchable(rElement,groupId)&&(graphic.setStyle(rElement,"selectable"),handleShapeSelect(groupId),activeDrop=null)},ondragleave:function(e){_isMatchable(rElement,e.relatedTarget.dataset.groupid)&&(graphic.setStyle(rElement,"selectable"),activeDrop=null)}})},_renderGapList=function(interaction,$gapList){function toggleActiveGapState($target){$target.hasClass("disabled")||($target.hasClass("active")?_setInactiveGapState($target):_setActiveGapState($target))}function _setActiveGapState($target){$gapList.children("li").removeClass("active"),$target.addClass("active"),
_shapesSelectable(interaction,$target.data("groupid")||"")}function _setInactiveGapState($target){$target.removeClass("active"),_shapesUnSelectable(interaction)}var dragOptions,scaleX,scaleY,gapFillersSelector=$gapList.selector+" li";interact(gapFillersSelector).on("tap",function(e){document.getElementsByClassName("prevent-click-handler").length||(e.stopPropagation(),e.preventDefault(),toggleActiveGapState($(e.currentTarget)))}),dragOptions={inertia:!1,autoScroll:!0,restrict:{restriction:".qti-interaction",endOnly:!1,elementRect:{top:0,left:0,bottom:1,right:1}}},$(gapFillersSelector).each(function(index,gap){interact(gap).draggable(_.assign({},dragOptions,{
onstart:function(e){var scale,$target=$(e.target);_setActiveGapState($target),$target.addClass("dragged"),_iFrameDragFix(gapFillersSelector,e.target),scale=interactUtils.calculateScale(e.target),scaleX=scale[0],scaleY=scale[1]},onmove:function(e){interactUtils.moveElement(e.target,e.dx/scaleX,e.dy/scaleY)},onend:function(e){_.defer(function(){var $target=$(e.target);_setInactiveGapState($target),$target.removeClass("dragged"),interactUtils.restoreOriginalPosition($target),interactUtils.iFrameDragFixOff()})}})).styleCursor(!1)})},setResponse=function(interaction,response){var $container=containerHelper.get(interaction),responseValues=null
;response&&interaction.paper&&(response.list&&response.list.directedPair&&(responseValues=response.list.directedPair),_.isArray(responseValues)&&_.forEach(interaction.getChoices(),function(choice){var element=interaction.paper.getById(choice.serial);element&&_.forEach(responseValues,function(pair){var responseChoice,responseGap;2===pair.length&&(responseChoice=pair[1],responseGap=pair[0],responseChoice===choice.serial&&($('[data-identifier="'+responseGap+'"]',$container).addClass("active"),_selectShape(interaction,element,!1)))})}))},_selectShape=function(interaction,element,trackResponse){
var $img,$clone,gapFiller,fillers,id,bbox,shapeOffset,activeOffset,matching,filler,$container=containerHelper.get(interaction),$gapList=$("ul",$container),$active=$gapList.find(".active:first"),$imageBox=$(".main-image-box",$container),boxOffset=$imageBox.offset();if(void 0===trackResponse&&(trackResponse=!0),$active.length){id=$active.data("identifier"),matching=element.data("matching")||[],matching.push(id),element.data("matching",matching),fillers=element.data("fillers")||[],$img=$active.find("img"),_shapesUnSelectable(interaction),$gapList.children().removeClass("active"),_setChoice(interaction,$active),$clone=$img.clone(),
shapeOffset=$(element.node).offset(),activeOffset=$active.offset(),$clone.css({position:"absolute",display:"block","z-index":1e4,opacity:.8,top:activeOffset.top-boxOffset.top,left:activeOffset.left-boxOffset.left}),$clone.appendTo($imageBox),$clone.animate({top:shapeOffset.top-boxOffset.top,left:shapeOffset.left-boxOffset.left},20,function(){var gapFillerImage,pos,width,height;$clone.remove(),bbox=element.getBBox(),width=parseInt($img.attr("width"),10),height=parseInt($img.attr("height"),10),filler=fillers.slice(-1)[0],pos=getPosition(bbox,filler?filler.getBBox():null,width),gapFiller=graphic.createBorderedImage(interaction.paper,{url:$img.attr("src"),
left:pos.left,top:pos.top,width:width,height:height,padding:0,border:!0}).data("identifier",id).toFront(),fillers.push(gapFiller),element.data("fillers",fillers),gapFillerImage=gapFiller[1].node,interact(gapFillerImage).on("tap",function(e){if(!document.getElementsByClassName("prevent-click-handler").length){var bbox,target=e.currentTarget,rElement=interaction.paper.getById(target.raphaelid),prevBBox=null;e.preventDefault(),e.stopPropagation(),$gapList.find(".active").length>0?interactUtils.tapOn(element.node):(matching=element.data("matching")||[],id=matching.indexOf(rElement.data("identifier")),id>-1&&(matching.splice(id,1),
element.data("matching",matching)),interaction.gapFillers=_.without(interaction.gapFillers,gapFiller),fillers=element.data("fillers")||[],id=fillers.indexOf(gapFiller),id>-1&&(fillers.splice(id,1),element.data("fillers",fillers)),gapFiller.remove(),bbox=element.getBBox(),_.forEach(fillers,function(filler){var width=filler.getBBox().width,pos=getPosition(bbox,prevBBox,width);filler.move(pos.left,pos.top,100),prevBBox={y:pos.top,x2:pos.left+width}}),_unsetChoice(interaction,$active),containerHelper.triggerResponseChangeEvent(interaction))}}),interaction.gapFillers.push(gapFiller),containerHelper.triggerResponseChangeEvent(interaction)})
;var getPosition=function(bbox,prevBBox,width){var maxBottom,left,top;return prevBBox?(left=prevBBox.x2+8,left+width>bbox.x2?(maxBottom=_(fillers).filter(function(filler){return filler.getBBox().y===prevBBox.y}).map(function(filler){return filler.getBBox().y2}).max(_.map(fillers)),left=bbox.x+4,top=maxBottom+4):top=prevBBox.y,{left:left,top:top}):{left:bbox.x+4,top:bbox.y+4}}}},_setChoice=function(interaction,$choice){var matchMax,usages,choiceSerial=$choice.data("serial"),choice=_.find(interaction.prop("gaps"),{serial:choiceSerial});interaction.choiceUsages[choiceSerial]||(interaction.choiceUsages[choiceSerial]=0),interaction.choiceUsages[choiceSerial]++,
!interaction.responseMappingMode&&choice.matchMax&&(matchMax=+choice.matchMax,usages=+interaction.choiceUsages[choiceSerial],0!==matchMax&&matchMax<=usages&&(interact($choice.get(0)).draggable(!1),$choice.addClass("disabled"),$choice.removeClass("selectable")))},_unsetChoice=function(interaction,$choice){var choiceSerial=$choice.data("serial");interaction.choiceUsages[choiceSerial]--,$choice.removeClass("disabled"),$choice.addClass("selectable"),interact($choice.get(0)).draggable(!0)},_getRawResponse=function(interaction){var element,matching,matchMin,pairs=[],isValid=!0;return _.forEach(interaction.getChoices(),function(choice){var gapImgsArray
;(element=interaction.paper.getById(choice.serial))&&(matchMin=choice.attributes.matchMin,matching=element.data("matching"),_.isArray(matching)&&(matchMin&&matchMin>matching.length&&(isValid=!1),interaction.getProperties().preserveImgCount?(gapImgsArray=element.data("matching"),interaction.getProperties().preserveImgOrder||gapImgsArray.sort(),pairs.push([gapImgsArray.join("__")||"null",choice.attributes.identifier])):_.forEach(matching,function(gapImg){pairs.push([gapImg,choice.serial])})))}),{isValid:isValid,list:_.sortBy(pairs,[0,1])}},nmcGraphGapMatchInteraction={id:-1,getTypeIdentifier:function(){return"nmcGraphGapMatchInteraction"},
initialize:function(id,dom,config){var $gapList,pci=this._taoCustomInteraction;this.id=id,this.dom=dom,this.config=config||{},this.$container=$(dom),pci.gapFillers=[],pci.choiceUsages={},$gapList=containerHelper.get(pci).find("ul.source"),pci.widgetRenderer||(pci.widgetRenderer=new Renderer({serial:pci.serial,$container:this.$container,interaction:pci}),pci.choices=_.reduce(pci.prop("choices"),function(acc,choice){return acc[choice.identifier]={serial:choice.identifier,attributes:choice},acc},{}),pci.widgetRenderer.render(pci.properties),_.forEach(pci.getChoices(),_.partial(_renderChoice,pci)),_renderGapList(pci,$gapList)),
pci.metaData.widget&&pci.metaData.widget.getCurrentState()&&"customCorrect"===pci.metaData.widget.getCurrentState().name&&(_.forEach(pci.getChoices(),_.partial(_renderChoice,pci)),_renderGapList(pci,$gapList))},setResponse:function(response){},getResponse:function(){var raw=_getRawResponse(this._taoCustomInteraction);return{list:{directedPair:raw.isValid?raw.list:null}}},resetResponse:function(){},destroy:function(){var $container,interaction=this._taoCustomInteraction;interaction.paper&&($container=containerHelper.get(interaction),$(window).off("resize.qti-widget."+interaction.serial),$container.off("resize.qti-widget."+interaction.serial),
interaction.paper.clear(),instructionMgr.removeInstructions(interaction),$(".main-image-box",$container).empty().removeAttr("style"),$(".image-editor",$container).removeAttr("style"),$("ul",$container).empty(),interact($container.find("ul.source li").selector).unset(),interact($container.find(".main-image-box rect").selector).unset()),containerHelper.reset(interaction)},setSerializedState:function(state){setResponse(this._taoCustomInteraction,state.response)},getSerializedState:function(){return{response:{list:{directedPair:_getRawResponse(this._taoCustomInteraction).list}}}},resetSerializedState:function(){},_selectShape:_selectShape}
;qtiCustomInteractionContext.register(nmcGraphGapMatchInteraction)}),function(c){var d=document,a="appendChild",i="styleSheet",s=d.createElement("style");s.type="text/css",d.getElementsByTagName("head")[0][a](s),s[i]?s[i].cssText=c:s[a](d.createTextNode(c))
}(".nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction{display:flex}.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-top,.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-bottom{flex-direction:column}.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-left,.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-right{flex-direction:row}.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-left ul.source.block-listing,.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-right ul.source.block-listing{width:auto}.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-left .image-container,.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-right .image-container{width:50%}.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-left .image-container .main-image-box,.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-right .image-container .main-image-box{max-width:100%}.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-left .image-container .main-image-box .svggroup,.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-right .image-container .main-image-box .svggroup{max-width:100%}.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-left .image-container .main-image-box .svggroup svg,.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-right .image-container .main-image-box .svggroup svg{max-width:100%}.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-top .image-container,.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-left .image-container{order:2}.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-top .block-listing,.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-left .block-listing{order:1}.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-bottom .image-container,.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-right .image-container{order:1}.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-bottom .block-listing,.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-right .block-listing{order:2}.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-left .image-sidebar{left:unset;right:-45px}.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-top ul.source>li img ~ span.mini-tlb[data-edit]{top:unset !important}.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-left ul.source>li img ~ span.mini-tlb[data-edit]{right:-28px}.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction.gap-position-right ul.source>li img ~ span.mini-tlb[data-edit]{right:unset;left:-28px}.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction .image-container{flex:1}.nmc-graph-gap-match-interaction.qti-graphicGapMatchInteraction ul.source>li.qti-gapImg{min-width:unset;min-height:unset}\n\n/*# sourceMappingURL=nmcGraphGapMatchInteraction.css.map */"),
define(["nmcGraphGapMatchInteraction/runtime/js/nmcGraphGapMatchInteraction"],function(PCI){return PCI});
//# sourceMappingURL=nmcGraphGapMatchInteraction.min.js.map