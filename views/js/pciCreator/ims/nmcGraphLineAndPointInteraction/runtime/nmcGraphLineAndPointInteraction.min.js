...
define('nmcPci/portableLib/gridFactory',['taoQtiItem/portableLib/lodash'], function( _ ){
...
define('nmcPci/portableLib/pointFactory',['taoQtiItem/portableLib/jquery_2_1_1', 'taoQtiItem/portableLib/lodash'], function($, _){
    'use strict';
...
define('nmcGraphLineAndPointInteraction/runtime/wrappers/setOfPoints',[
...
define('nmcGraphLineAndPointInteraction/runtime/wrappers/points',['nmcGraphLineAndPointInteraction/runtime/wrappers/setOfPoints'], function(setOfPoints){
    function initialize(grid, config) {
        var point;
        config.max = 1;
...
define('nmcPci/portableLib/graphFunction',['taoQtiItem/portableLib/lodash'], function(_){
...
define('nmcPci/portableLib/plotFactory',['taoQtiItem/portableLib/lodash', 'nmcPci/portableLib/graphFunction'], function(_, graphFunction){
...
define('nmcGraphLineAndPointInteraction/runtime/wrappers/lines',[
    'taoQtiItem/portableLib/jquery_2_1_1',
    'taoQtiItem/portableLib/lodash',
    'nmcPci/portableLib/pointFactory',
...
define('nmcGraphLineAndPointInteraction/runtime/wrappers/segments',['nmcGraphLineAndPointInteraction/runtime/wrappers/lines'], function(lines){
...
define('nmcPci/portableLib/poligonFactory',['taoQtiItem/portableLib/lodash', 'nmcPci/portableLib/graphFunction'], function(_, graphFunction){
...
define('nmcGraphLineAndPointInteraction/runtime/wrappers/polygons',[
    'taoQtiItem/portableLib/jquery_2_1_1',
    'taoQtiItem/portableLib/lodash',
    'nmcPci/portableLib/pointFactory',
    'nmcPci/portableLib/plotFactory',
...
define('nmcGraphLineAndPointInteraction/runtime/wrappers/solutionSet',[
    'taoQtiItem/portableLib/jquery_2_1_1',
    'taoQtiItem/portableLib/lodash'
], function($, _){
...
define('css!nmcGraphLineAndPointInteraction/runtime/css/nmcGraphLineAndPointInteraction',[],function(){});
/**
 * This program is free software; you can redistribute it and/or
 * modify it under the terms of the GNU General Public License
 * as published by the Free Software Foundation; under version 2
...
define('nmcGraphLineAndPointInteraction/runtime/nmcGraphLineAndPointInteraction',[
    'taoQtiItem/portableLib/jquery_2_1_1',
