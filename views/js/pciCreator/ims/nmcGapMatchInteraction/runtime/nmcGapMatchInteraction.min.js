...
;"function"==typeof define&&"object"==typeof define.amd&&define.amd?(Z._=ut,define("taoQtiItem/portableLib/lodash",[],function(){return ut})):nt&&tt?et?(tt.exports=ut)._=ut:nt._=ut:Z._=ut}.call(this),define("css!nmcGapMatchInteraction/runtime/css/nmcGapMatchInteraction",[],function(){}),define("nmcGapMatchInteraction/runtime/nmcGapMatchInteraction",["taoQtiItem/portableLib/jquery_2_1_1","qtiCustomInteractionContext","taoQtiItem/portableLib/lodash","css!nmcGapMatchInteraction/runtime/css/nmcGapMatchInteraction"],function($,qtiCustomInteractionContext,_){"use strict";var nmcGapMatchInteraction={id:-1,getInstance:function(dom,config,state){
var response=config.boundTo;this.initialize(Object.getOwnPropertyNames(response).pop(),dom,config.properties,config.assetManager),this.setSerializedState(state),"function"==typeof config.onready&&config.onready(this,this.getState())},getState:function(){return this.getSerializedState()},oncompleted:function(){this.destroy()},getResponse:function(){return{list:{pair:this.isValidResponse()?this.getRawResponse():null}}},destroy:function(){$(this.dom).off().empty()},getTypeIdentifier:function(){return"nmcGapMatchInteraction"},initialize:function(id,dom,config){function getGaps(){var gapElems=Array.prototype.slice.call(dom.querySelectorAll(".empty-gap[data-id]"))
;return gapElems=gapElems.filter(function(gapElem){return"span"===gapElem.tagName.toLowerCase()||1===dom.querySelectorAll('.empty-gap[data-id="'+gapElem.getAttribute("data-id")+'"]').length})}function initAfterMathJax(){dom.querySelectorAll(".MathJax span.empty-gap").forEach(function(el){var id=el.getAttribute("data-id");dom.querySelectorAll('mspace[data-id="'+id+'"]').forEach(function(elem){elem.setAttribute("data-math-id",elem.getAttribute("data-id")),elem.setAttribute("data-secondary",!0)})}),self.removeAllListeners(),self.initAllListeners()}function getParentJax(elem){var jaxRoot,roots=MathJax.Hub.getAllJax(dom.querySelector(".qti-flow-container"))
;return roots.some(function(rootElem){var id="#"+rootElem.inputID+"-Frame";if($(elem).closest(id).length>0)return jaxRoot=rootElem,!0}),jaxRoot}var boxes,emptyGaps,currentGapId,styledElems,self=this,dragged=void 0,mathJax=window.MathJax;id&&(this.id=id),this.dom=dom,this.config=config||{},this.getGaps=getGaps,this.getRawResponse=function(){return getGaps().map(function(gap){var choice=gap.querySelector(".gap-choice");return[gap.getAttribute("data-id")||"",choice?choice.getAttribute("data-id"):"null"]})},this.mouseMove=function(event){dragged&&(dragged.style.position="fixed",dragged.style.left=event.x+"px",dragged.style.top=event.y+"px")},
this.isDisabled=function(choice){var limit,gapElems;return!!choice.dataset.matchmax&&(!!(limit=parseInt(choice.dataset.matchmax,10))&&(gapElems=getGaps(),$(gapElems).find('.gap-choice[data-id="'+choice.dataset.id+'"]').length>=limit))},this.isValidResponse=function(){var gapElems,minChoices=this.config.minChoices;return!minChoices||(gapElems=getGaps(),$(gapElems).find(".gap-choice").length>=minChoices)},this.disableChoices=function(){dom.querySelectorAll(".choice-container .gap-choice").forEach(function(choice){if(self.isDisabled(choice))return void choice.classList.add("disabled");choice.classList.remove("disabled")})},this.unDisableChoices=function(){
dom.querySelectorAll(".choice-container .gap-choice").forEach(function(choice){choice.classList.remove("disabled")})},this.hlAvailible=function(){dragged&&getGaps().filter(function(gap){return"true"!==gap.getAttribute("data-full")&&gap.getAttribute("data-groupid")===dragged.getAttribute("data-groupid")}).forEach(function(gap){gap.classList.add("availible")})},this.unHlAvailible=function(){getGaps().forEach(function(gap){gap.classList.remove("availible")})},this.drag=function(event){var elem;event.currentTarget.classList.contains("disabled")||(elem=event.currentTarget.cloneNode(!0),event.currentTarget.parentNode.appendChild(elem),dragged=elem,
dragged.classList.add("dragged"),dom.addEventListener("mousemove",self.mouseMove),dragged.style.pointerEvents="none",dragged.style.backgoundColor="white",self.mouseMove(event),self.hlAvailible())},this.dragFromGap=function(event){var currGap,elem=event.currentTarget,gapid=elem.dataset.gap,currGaps=dom.querySelectorAll('.empty-gap[data-id="'+gapid+'"]');currGaps.forEach(function(gapElem){"span"!==gapElem.tagName.toLowerCase()&&1!==currGaps.length||(currGap=gapElem)}),currGap&&(currGap.setAttribute("data-full","false"),self.drag(event),setTimeout(function(){elem.remove()},0))},this.drop=function(){
var currGaps,gap,gapSource,newGapSource,root,newMath,jaxRoot,MathJax=window.MathJax;dom.removeEventListener("mousemove",self.mouseMove),dragged&&(dragged.style="",$(dragged).siblings(".dragged").remove(),currGaps=dom.querySelectorAll('.empty-gap[data-id="'+currentGapId+'"]'),currGaps.forEach(function(gapElem){"span"!==gapElem.tagName.toLowerCase()&&1!==currGaps.length||(gap=gapElem)}),gap&&gap.getAttribute("data-groupid")===dragged.getAttribute("data-groupid")&&"true"!==gap.getAttribute("data-full")?self.putChoiceIntoGap(dragged,gap):(dragged.remove(),
gapSource=dom.querySelector('math [data-math-id="'+dragged.getAttribute("data-gap")+'"]')||dom.querySelector('math [data-id="'+dragged.getAttribute("data-gap")+'"]'),window.MathJax&&gapSource&&(newGapSource=$('<mspace width="3em" height="1.4em" class="empty-gap"></mspace>')[0],newGapSource.setAttribute("data-id",gapSource.getAttribute("data-id")||gapSource.getAttribute("data-math-id")),gapSource.after(newGapSource),root=$(gapSource).closest("math")[0],gapSource.remove(),gapSource=newGapSource,newMath="<math>"+root.innerHTML+"</math>",jaxRoot=getParentJax(gapSource),MathJax.Hub.Queue(["Text",jaxRoot,newMath]),MathJax.Hub.Queue(initAfterMathJax))),
dragged.classList.remove("dragged"),dragged=void 0,self.unHlAvailible(),self.disableChoices())},this.putChoiceIntoGap=function(draggedClone,gap){var gapSource,m,mathChoice,newGapSource,root,newMath,jaxRoot,MathJax=window.MathJax;draggedClone.dataset.gap=gap.getAttribute("data-id"),draggedClone.addEventListener("mousedown",self.dragFromGap),gap.appendChild(draggedClone),gap.setAttribute("data-full",!0),gapSource=dom.querySelector('math [data-math-id="'+gap.getAttribute("data-id")+'"]')||dom.querySelector('math [data-id="'+gap.getAttribute("data-id")+'"]'),
window.MathJax&&gapSource&&(m=draggedClone.querySelector("math")?draggedClone.querySelector("math").innerHTML:"<mtext>"+draggedClone.innerText+"</mtext>",mathChoice=$('<mrow class="gap-choice">'+m+"</mrow>")[0],mathChoice.setAttribute("data-id",draggedClone.getAttribute("data-id")),mathChoice.setAttribute("data-groupid",draggedClone.getAttribute("data-groupid")),mathChoice.setAttribute("data-gap",draggedClone.getAttribute("data-gap")),newGapSource=$('<mrow class="empty-gap">'+gapSource.innerHTML+"</mrow>")[0],newGapSource.setAttribute("data-id",gapSource.getAttribute("data-math-id")||gapSource.getAttribute("data-id")),
newGapSource.setAttribute("data-full",!0),gapSource.after(newGapSource),newGapSource.appendChild(mathChoice),root=$(gapSource).closest("math")[0],gapSource.remove(),gapSource=newGapSource,newMath="<math>"+root.innerHTML+"</math>",jaxRoot=getParentJax(gapSource),MathJax.Hub.Queue(["Text",jaxRoot,newMath]),MathJax.Hub.Queue(initAfterMathJax),MathJax.Hub.Queue(function(){gap.setAttribute("data-full",!0),newGapSource.setAttribute("data-full",!0)}))},this.enterGap=function(event){var gap=event.currentTarget;"true"!==gap.getAttribute("data-full")&&(currentGapId=gap.getAttribute("data-id"))},this.leaveGap=function(){currentGapId=-1},
this.removeAllListeners=function(){dom.removeEventListener("mousemove",self.mouseMove),emptyGaps.forEach(function(gap){gap.removeEventListener("mouseenter",self.enterGap),gap.removeEventListener("mouseleave",self.leaveGap)}),boxes.forEach(function(box){box.removeEventListener("mousedown",self.drag),dom.removeEventListener("mouseup",self.drop),box.removeEventListener("mousedown",self.dragFromGap)}),self.unDisableChoices(),self.unHlAvailible()},this.initAllListeners=function(){var choicesInsideGaps=dom.querySelectorAll(".empty-gap[data-id] .gap-choice");boxes=dom.querySelectorAll(".gap-choice"),boxes.forEach(function(box){
box.addEventListener("mousedown",self.drag),dom.addEventListener("mouseup",self.drop)}),emptyGaps=dom.querySelectorAll(".empty-gap[data-id]"),emptyGaps.forEach(function(gap){gap.addEventListener("mouseenter",self.enterGap),gap.addEventListener("mouseleave",self.leaveGap)}),choicesInsideGaps.forEach(function(draggedClone){draggedClone.addEventListener("mousedown",self.dragFromGap),draggedClone.removeEventListener("mousedown",self.drag)})},self.initAllListeners(),styledElems=dom.querySelectorAll("[data-style]"),styledElems.forEach(function(elem){elem.getAttribute("style")||elem.setAttribute("style",elem.getAttribute("data-style"))}),
mathJax&&(mathJax.Hub.Queue(["Typeset",mathJax.Hub]),mathJax.Hub.Queue(initAfterMathJax))},setResponse:function(response){},resetResponse:function(){},setSerializedState:function(state){this.setResponse(state)},getSerializedState:function(){return this.getResponse()}};qtiCustomInteractionContext.register(nmcGapMatchInteraction)}),function(c){var d=document,a="appendChild",i="styleSheet",s=d.createElement("style");s.type="text/css",d.getElementsByTagName("head")[0][a](s),s[i]?s[i].cssText=c:s[a](d.createTextNode(c))
}('.nmcGapMatchInteraction {\r\n  user-select: none;\r\n}\r\n.nmcGapMatchInteraction .empty-gap {\r\n  background: white;\r\n  min-width: 50px;\r\n  min-height: 20px;\r\n  color: transparent;\r\n  display: inline-block;\r\n  border: 1px solid black;\r\n  position: relative;\r\n}\r\n.nmcGapMatchInteraction .empty-gap.availible {\r\n  border: 1.5px #2873ba dashed;\r\n}\r\n.nmcGapMatchInteraction .empty-gap.availible:hover {\r\n  background-color: #cfdfe9;\r\n}\r\n.nmcGapMatchInteraction .empty-gap .gap-choice {\r\n  list-style: none;\r\n  display: inline-block;\r\n  color: black;\r\n  background: transparent;\r\n  line-height: normal;\r\n}\r\n.nmcGapMatchInteraction .MathJax .empty-gap {\r\n  min-height: 0;\r\n  min-width: 0;\r\n  border-width: 0;\r\n  background-color: rgba(70, 100, 200, 0.1);\r\n}\r\n.nmcGapMatchInteraction .MathJax .empty-gap.availible {\r\n  border: 1.5px #2873ba dashed;\r\n}\r\n.nmcGapMatchInteraction .MathJax .empty-gap.availible:hover {\r\n  background-color: #cfdfe9;\r\n}\r\n.nmcGapMatchInteraction mrow {\r\n  padding: 3px 0;\r\n}\r\n.nmcGapMatchInteraction .choice-container {\r\n  display: flex;\r\n  align-items: baseline;\r\n  justify-content: start;\r\n  flex-wrap: wrap;\r\n  padding: 3px;\r\n  margin: 10px 0;\r\n  border: 6px solid #f5f4f2;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice {\r\n  position: relative;\r\n  border: 1px solid #2873ba;\r\n  border-radius: 4px;\r\n  padding: 2px;\r\n  margin: 2px;\r\n  color: #2873ba;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice:hover, .nmcGapMatchInteraction .choice-container .gap-choice:focus-within {\r\n  z-index: 1001;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice.disabled {\r\n  opacity: 0.55;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice.disabled:hover {\r\n  box-shadow: none;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-column="1"] {\r\n  -ms-grid-column: 1;\r\n  grid-column: 1;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-column="2"] {\r\n  -ms-grid-column: 2;\r\n  grid-column: 2;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-column="3"] {\r\n  -ms-grid-column: 3;\r\n  grid-column: 3;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-column="4"] {\r\n  -ms-grid-column: 4;\r\n  grid-column: 4;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-column="5"] {\r\n  -ms-grid-column: 5;\r\n  grid-column: 5;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-row="1"] {\r\n  -ms-grid-row: 2;\r\n  grid-row: 2;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-row="2"] {\r\n  -ms-grid-row: 3;\r\n  grid-row: 3;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-row="3"] {\r\n  -ms-grid-row: 4;\r\n  grid-row: 4;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-row="4"] {\r\n  -ms-grid-row: 5;\r\n  grid-row: 5;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-row="5"] {\r\n  -ms-grid-row: 6;\r\n  grid-row: 6;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-row="6"] {\r\n  -ms-grid-row: 7;\r\n  grid-row: 7;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-row="7"] {\r\n  -ms-grid-row: 8;\r\n  grid-row: 8;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-row="8"] {\r\n  -ms-grid-row: 9;\r\n  grid-row: 9;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-row="9"] {\r\n  -ms-grid-row: 10;\r\n  grid-row: 10;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-row="10"] {\r\n  -ms-grid-row: 11;\r\n  grid-row: 11;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-row="11"] {\r\n  -ms-grid-row: 12;\r\n  grid-row: 12;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-row="12"] {\r\n  -ms-grid-row: 13;\r\n  grid-row: 13;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-row="13"] {\r\n  -ms-grid-row: 14;\r\n  grid-row: 14;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-row="14"] {\r\n  -ms-grid-row: 15;\r\n  grid-row: 15;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-row="15"] {\r\n  -ms-grid-row: 16;\r\n  grid-row: 16;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-row="16"] {\r\n  -ms-grid-row: 17;\r\n  grid-row: 17;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-row="17"] {\r\n  -ms-grid-row: 18;\r\n  grid-row: 18;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-row="18"] {\r\n  -ms-grid-row: 19;\r\n  grid-row: 19;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-row="19"] {\r\n  -ms-grid-row: 20;\r\n  grid-row: 20;\r\n}\r\n.nmcGapMatchInteraction .choice-container .gap-choice[data-row="20"] {\r\n  -ms-grid-row: 21;\r\n  grid-row: 21;\r\n}\r\n.nmcGapMatchInteraction .choice-container .add-option {\r\n  margin: 2px;\r\n  padding: 4px;\r\n}\r\n.nmcGapMatchInteraction .choice-container .group {\r\n  padding: 5px;\r\n  margin: 5px;\r\n  border: 1px solid black;\r\n  border-radius: 4px;\r\n}\r\n.nmcGapMatchInteraction .choice-container .group .choices {\r\n  display: flex;\r\n  flex-direction: column;\r\n  align-items: flex-start;\r\n}\r\n.nmcGapMatchInteraction .choice-container .group-title {\r\n  margin: 3px 0;\r\n}\r\n.nmcGapMatchInteraction .choice-container .group-title:hover, .nmcGapMatchInteraction .choice-container .group-title:focus-within {\r\n  z-index: 1001;\r\n  position: relative;\r\n  background: white;\r\n}\r\n.nmcGapMatchInteraction .choice-container[data-columns] {\r\n  align-items: stretch;\r\n  display: -ms-grid;\r\n  display: grid;\r\n}\r\n.nmcGapMatchInteraction .choice-container[data-columns] .add-option {\r\n  -ms-grid-column: 1;\r\n  grid-column: 1;\r\n  -ms-grid-row: 21;\r\n  grid-row: 21;\r\n}\r\n.nmcGapMatchInteraction .choice-container[data-columns="1"] {\r\n  -ms-grid-columns: 1fr;\r\n  grid-template-columns: repeat(1, 1fr);\r\n}\r\n.nmcGapMatchInteraction .choice-container[data-columns="2"] {\r\n  -ms-grid-columns: 1fr 1fr;\r\n  grid-template-columns: repeat(2, 1fr);\r\n}\r\n.nmcGapMatchInteraction .choice-container[data-columns="3"] {\r\n  -ms-grid-columns: 1fr 1fr 1fr;\r\n  grid-template-columns: repeat(3, 1fr);\r\n}\r\n.nmcGapMatchInteraction .choice-container[data-columns="4"] {\r\n  -ms-grid-columns: 1fr 1fr 1fr 1fr;\r\n  grid-template-columns: repeat(4, 1fr);\r\n}\r\n.nmcGapMatchInteraction .choice-container[data-columns="5"] {\r\n  -ms-grid-columns: 1fr 1fr 1fr 1fr 1fr;\r\n  grid-template-columns: repeat(5, 1fr);\r\n}\r\n.nmcGapMatchInteraction .gap-choice {\r\n  background: white;\r\n  cursor: pointer;\r\n}\r\n.nmcGapMatchInteraction .gap-choice:hover {\r\n  background-color: #e9e7e8;\r\n  box-shadow: inset 0 0 0px 0.5px #2873ba;\r\n  border-color: #2873ba;\r\n}\r\n.nmcGapMatchInteraction .gap-choice div[data-html-editable] {\r\n  display: inline-block;\r\n}\r\n.nmcGapMatchInteraction .gap-choice.dragged {\r\n  background: white;\r\n  position: relative;\r\n  border: 1px solid #2873ba;\r\n  border-radius: 4px;\r\n  padding: 0 2px;\r\n  margin: 0 2px;\r\n  color: #2873ba;\r\n  z-index: 1001;\r\n  transform: translate(-50%, -50%);\r\n}\r\n.nmcGapMatchInteraction .qti-flow-container[data-html-editable-container=true] .empty-gap:hover {\r\n  cursor: pointer;\r\n  background-color: #e9e7e8;\r\n}\r\n.nmcGapMatchInteraction .qti-flow-container table {\r\n  margin-left: auto;\r\n  margin-right: auto;\r\n}\r\n.nmcGapMatchInteraction .br {\r\n  display: block;\r\n  width: 0;\r\n  height: 0;\r\n  box-sizing: border-box;\r\n  margin: 0;\r\n  padding: 0;\r\n  opacity: 0;\r\n}\r\n.nmcGapMatchInteraction .choice-position-container {\r\n  word-break: break-word;\r\n  display: flex;\r\n}\r\n.nmcGapMatchInteraction .choice-position-container.position-top {\r\n  flex-direction: column;\r\n}\r\n.nmcGapMatchInteraction .choice-position-container.position-bottom {\r\n  flex-direction: column-reverse;\r\n}\r\n.nmcGapMatchInteraction .choice-position-container.position-left {\r\n  flex-direction: row;\r\n}\r\n.nmcGapMatchInteraction .choice-position-container.position-right {\r\n  flex-direction: row-reverse;\r\n}\r\n.nmcGapMatchInteraction .choice-position-container .choice-area {\r\n  flex-basis: 50%;\r\n  flex-grow: 0;\r\n}\r\n.nmcGapMatchInteraction .choice-position-container .qti-flow-container {\r\n  flex-basis: 50%;\r\n  flex-grow: 1;\r\n}\r\n.nmcGapMatchInteraction .gap-col-1-5 {\r\n  width: 20%;\r\n}\r\n.nmcGapMatchInteraction .gap-col-1-4 {\r\n  width: 25%;\r\n}\r\n.nmcGapMatchInteraction .gap-col-1-3 {\r\n  width: 33.33333333%;\r\n}\r\n.nmcGapMatchInteraction .gap-col-1-2 {\r\n  width: 50%;\r\n}\r\n.nmcGapMatchInteraction .gap-col-1-1 {\r\n  width: 100%;\r\n}\r\n\r\n.edit-sleep .nmcGapMatchInteraction .feedback-min-choices,\r\n.adit-active .nmcGapMatchInteraction .feedback-min-choices {\r\n  display: none;\r\n}\r\n\r\n/*# sourceMappingURL=nmcGapMatchInteraction.css.map */\r\n'),
define(["nmcGapMatchInteraction/runtime/nmcGapMatchInteraction"],function(IMSPCI){return IMSPCI});
//# sourceMappingURL=nmcGapMatchInteraction.min.js.map