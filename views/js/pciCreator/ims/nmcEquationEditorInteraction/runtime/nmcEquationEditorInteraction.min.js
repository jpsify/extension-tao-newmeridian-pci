...
},this.trigger=function(event,data){events[event]&&_.forEach(events[event],function(e){e.callback.apply({type:event,ns:[]},data)})}}}),define("taoQtiItem/portableLib/OAT/util/event",["taoQtiItem/portableLib/OAT/util/EventMgr"],function(EventMgr){return{addEventMgr:function(instance){var eventMgr=new EventMgr;instance.on=function(event,callback){eventMgr.on(event,callback)},instance.off=function(event){eventMgr.off(event)},instance.trigger=function(event,data){eventMgr.trigger(event,data)}}}}),define("nmcPci/portableLib/equationEditor/mathJaxEditor/lower",["exports"],function(_exports){"use strict";function lower(a){return a.toLowerCase()}
Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.default=lower}),define("nmcPci/portableLib/equationEditor/mathJaxEditor/add",["exports","nmcPci/portableLib/equationEditor/mathJaxEditor/lower"],function(_exports,_lower){"use strict";function add(what,source){switch((0,_lower.default)(source.tagName)){case"mrow":case"math":return source.children.length?(source.insertBefore(what,source.lastElementChild.nextSibling),!0):(source.appendChild(what),!0);default:return source.parentNode.insertBefore(what,source),!0}}Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.default=add}),
define("nmcPci/portableLib/equationEditor/mathJaxEditor/del",["exports","nmcPci/portableLib/equationEditor/mathJaxEditor/lower"],function(_exports,_lower){"use strict";function del(value,current,initial,readonly){var parent=current.parentNode;if(readonly&&(current.hasAttribute("editable")||initial&&initial.hasAttribute("editable")))return initial||current;if(current.parentNode&&"mroot"===current.parentNode.tagName.toLowerCase()&&"mrow"==current.tagName.toLowerCase()){if(!current.children.length)return initial||current;current=current.children[current.children.length-1]}if("ee-gap"===current.className)return initial||current;switch((0,
_lower.default)(current.tagName)){case"math":if(!current.children.length)return current;parent=current,current=current.children[current.children.length-1]}var to=current.nextElementSibling||parent;return parent.removeChild(current),to}Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.default=del}),define("nmcPci/portableLib/equationEditor/mathJaxEditor/backspace",["exports","nmcPci/portableLib/equationEditor/mathJaxEditor/del","nmcPci/portableLib/equationEditor/mathJaxEditor/lower"],function(_exports,_del,_lower){"use strict";function backspace(value,current,readonly){
var parent=current.parentNode,previous=current.previousElementSibling,tag=(0,_lower.default)(current.tagName);switch(tag){case"mrow":case"math":return current.lastElementChild?(0,_del.default)(value,current.lastElementChild,current):"math"===tag?current:(0,_del.default)(value,parent,current,readonly)}return previous||"math"!==(0,_lower.default)(parent.tagName)?(0,_del.default)(value,previous||parent,current):current}Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.default=backspace}),define("nmcPci/portableLib/equationEditor/mathJaxEditor/each",["exports"],function(_exports){"use strict";function each(source,handler){!function walk(el){
var isContainer="mrow"===el.tagName.toLowerCase()||"math"===el.tagName.toLowerCase();if(isContainer||handler(el),el.children)for(var child=el.firstElementChild;child;)walk(child),child=child.nextElementSibling;isContainer&&handler(el)}(source)}Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.default=each}),define("nmcPci/portableLib/equationEditor/mathJaxEditor/id",["exports"],function(_exports){"use strict";function id(){return"mje-node".concat(counter++)}Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.default=id;var counter=0}),define("nmcPci/portableLib/equationEditor/mathJaxEditor/newline",["exports"],function(_exports){
"use strict";function isNewline(el){return"newline"===el.getAttribute("linebreak")}Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.default=isNewline}),define("nmcPci/portableLib/equationEditor/mathJaxEditor/display",["exports","nmcPci/portableLib/equationEditor/mathJaxEditor/each","nmcPci/portableLib/equationEditor/mathJaxEditor/id","nmcPci/portableLib/equationEditor/mathJaxEditor/lower","nmcPci/portableLib/equationEditor/mathJaxEditor/newline"],function(_exports,_each,_id,_lower,_newline){"use strict";function display(math){(0,_each.default)(math,function(source){source.id||(source.id=(0,_id.default)()),
source.editable&&source.setAttribute("editable","true")});var displayed=math.cloneNode(!0),mnewline=function(){return MathJax.HTML.Element("mo",{className:"mje-newline"},["⏎"])},mplaceholder=function(tag){return MathJax.HTML.Element("mi",{className:"mje-placeholder "+tag+"-placeholder"},["⬚"])};return(0,_each.default)(displayed,function(source){var tag=(0,_lower.default)(source.tagName);switch(tag){case"mspace":if(!source.id)break;if(!(0,_newline.default)(source))break;var next=source.nextElementSibling||displayed.lastElementChild,prev=displayed.firstChild,addNewlinePlaceholder=next===source;next&&"mspace"===(0,_lower.default)(next.tagName)&&(0,
_newline.default)(next)&&(addNewlinePlaceholder=!0),addNewlinePlaceholder&&source.parentNode.insertBefore(mnewline(),source.nextSibling),prev===source&&source.parentNode.insertBefore(mnewline(),source);break;case"mrow":case"math":if(!source.children.length){source.appendChild(mplaceholder(tag));break}break;default:skip.indexOf(tag)}}),displayed.outerHTML}Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.default=display;var skip=["mo","mi","mn","mspace","mfrac"]}),define("nmcPci/portableLib/equationEditor/mathJaxEditor/operators",["lodash"],function(_){"use strict";var frac=function(mje){
var msup,mrow,mrow2,node,currentNode,nextSibling,tagName,forwardNodes=mje.tryExpression(),trailingNodes=[],maxChar=1;if(currentNode=mje.getCurrentNode(),nextSibling=currentNode?currentNode.nextSibling:mje.raw().firstElementChild,(node=currentNode)&&!forwardNodes.length&&"mn"===(tagName=node.tagName.toLowerCase()))for(;node&&tagName===node.tagName.toLowerCase();)forwardNodes.unshift(node),node=node.previousSibling;if(!mje.allowText()&&(node=nextSibling)&&("mn"===(tagName=node.tagName.toLowerCase())||"mi"===tagName))for("mi"===tagName&&(forwardNodes=[]);node&&tagName===node.tagName.toLowerCase();)trailingNodes.push(node),node=node.nextSibling
;node=mje.getCurrentNode(),node&&"mtext"===node.tagName.toLowerCase()&&mje.whitespace(),msup=MathJax.HTML.Element("mfrac"),mrow=MathJax.HTML.Element("mrow"),msup.appendChild(mrow),mrow2=MathJax.HTML.Element("mrow"),_.forEachRight(forwardNodes,function(n){maxChar&&(mje.getCurrent()===n&&mje.setCurrent(n.nextSibling),n.remove(),mrow.insertBefore(n,mrow.firstChild),"mi"===n.tagName.toLowerCase()&&maxChar--)}),_.forEach(trailingNodes,function(n){maxChar&&(mje.getCurrent()===n&&mje.setCurrent(n.nextSibling),n.remove(),mrow2.appendChild(n),"mi"===n.tagName.toLowerCase()&&maxChar--)}),msup.appendChild(mrow2),mje.addElement(msup,forwardNodes.length?mrow2:mrow)
},groupTag=function(mje,tag,second,maxChar){var msup,mrow,node,tagName,newNodes=mje.tryExpression();if(maxChar=maxChar||999,(node=mje.getCurrentNode())&&!newNodes.length&&("mn"===(tagName=node.tagName.toLowerCase())||"mi"===tagName))for(;node&&tagName===node.tagName.toLowerCase();)newNodes.unshift(node),node=node.previousSibling;newNodes.length?(msup=MathJax.HTML.Element(tag),mrow=MathJax.HTML.Element("mrow"),msup.appendChild(mrow),_.forEachRight(newNodes,function(n){maxChar&&(n.remove(),mrow.insertBefore(n,mrow.firstChild),"mi"===n.tagName.toLowerCase()&&maxChar--)}),second?(msup.appendChild(second),mrow=null):(mrow=MathJax.HTML.Element("mrow"),
msup.appendChild(mrow)),mje.addElement(msup,mrow)):(node=mje.getCurrentNode(),node&&"mtext"===node.tagName.toLowerCase()&&mje.whitespace(),msup=MathJax.HTML.Element(tag),mrow=MathJax.HTML.Element("mrow"),msup.appendChild(mrow),msup.appendChild(second||MathJax.HTML.Element("mrow")),mje.addElement(msup,mrow))};return{binary:{"+":"+","-":"-","−":"-","±":"±","Σ":"Σ","∠":"∠","△":"△","▱":"▱","⊙":"⊙"},groups:{"[":"]","{":"}"},onlyMathGroups:{"(":")"},onlyText:{"}":"}","]":"]",")":")"},relations:{"=":"=","≠":"≠","∼":"∼","≁":"≁","<":"<",">":">","≈":"≈","≉":"≉","≤":"≤","≥":"≥","≅":"≅","≇":"≇","·":"·","*":["*","×"],"∥":"∥","⊥":"⊥","×":"×","÷":"÷","⁄":"⁄"},
onlyMathRelations:{"~":["~","∼"],":":":"},mathChars:{"π":"π","°":"°"},custom:{"|":function(mje){var mrow,emptyRow;mrow=MathJax.HTML.Element("mrow"),mrow.appendChild(MathJax.HTML.Element("mo",null,["|"])),emptyRow=MathJax.HTML.Element("mrow"),mrow.appendChild(emptyRow),mrow.appendChild(MathJax.HTML.Element("mo",{className:"soft"},["|"])),mje.addElement(mrow,emptyRow)},"`":function(mje){var msqrt=MathJax.HTML.Element("msqrt"),mrow=MathJax.HTML.Element("mrow");msqrt.appendChild(mrow),mje.tryExpression(),mje.addElement(msqrt,mrow)},"^":function(mje){groupTag(mje,"msup")},_:function(mje){groupTag(mje,"msub")},"'":function(mje){var node,element
;node=mje.getCurrentNode(),element=!mje.allowText()||node&&"mtext"!==node.tagName.toLowerCase()?MathJax.HTML.Element("mn",null,["'"]):MathJax.HTML.Element("mtext",null,["'"]),mje.addElement(element)},"/":function(mje){var node,mtext;mje.tryExpression(),node=mje.getCurrentNode(),node&&"mtext"===node.tagName.toLowerCase()?(mtext=MathJax.HTML.Element("mtext",null,["/"]),mje.addElement(mtext)):frac(mje)},"\\":function(mje){var node,mtext;mje.tryExpression(),node=mje.getCurrentNode(),node&&"mtext"===node.tagName.toLowerCase()?(mtext=MathJax.HTML.Element("mtext",null,["\\"]),mje.addElement(mtext)):frac(mje)},$:function(mje){
var mo,idBefore,node=mje.getCurrentNode(),count=0,tagName=node?node.tagName.toLowerCase():"";if("mn"===tagName){for(mje.left(),count++;node.previousSibling&&("mn"===node.previousSibling.tagName.toLowerCase()||"."===node.previousSibling.textContent);)node=node.previousSibling,mje.left(),count++;for(idBefore=node.previousSibling&&"mi"===node.previousSibling.tagName.toLowerCase(),idBefore&&(mo=MathJax.HTML.Element("mo",null,["("]),mje.addElement(mo)),mje.addElement(MathJax.HTML.Element("mi",null,["$"]));count--;)mje.right();idBefore&&(mo=MathJax.HTML.Element("mo",null,[")"]),mje.addElement(mo,mo))
}else"mi"===tagName?(tagName=node.previousSibling?node.previousSibling.tagName.toLowerCase():"","mi"===tagName||"mn"===tagName?mje.addElement(MathJax.HTML.Element("mrow")):(mje.left(),mje.addElement(MathJax.HTML.Element("mi",null,["$"])),mje.right())):(tagName=mje.getTagName("mi"),mje.addElement(MathJax.HTML.Element(tagName,null,["$"])))},"!":function(mje){var tagName,mrow,mrow1,bkt,node=mje.getCurrentNode(),selectable=node&&"true"===node.getAttribute("selectable");!node&&!mje.allowText()||node&&"mrow"===node.tagName.toLowerCase()?(mrow=MathJax.HTML.Element("mrow"),mrow1=MathJax.HTML.Element("mrow"),mrow.appendChild(mrow1),
mrow.appendChild(MathJax.HTML.Element("mo",null,["!"])),mje.addElement(mrow,mrow1)):(node&&"mover"===node.tagName.toLowerCase()&&!selectable&&($(MathJax.HTML.Element("mo",{},["("])).insertBefore(node),bkt=MathJax.HTML.Element("mo",{},[")"]),$(bkt).insertAfter(node)),tagName=mje.getTagName("mo"),mje.addElement(MathJax.HTML.Element(tagName,null,["!"])))},",":function(mje){var mtext,tagName,node=mje.getCurrentNode();!mje.allowText()||node&&"mtext"!==node.tagName.toLowerCase()&&"mi"!==node.tagName.toLowerCase()?node&&"mn"===node.tagName.toLowerCase()&&(tagName="mn"):tagName="mtext",tagName&&(mtext=MathJax.HTML.Element(tagName,null,[","]),mje.addElement(mtext))},
".":function(mje){var mtext,node=mje.getCurrentNode(),tagName="mn";!mje.allowText()||node&&"mtext"!==node.tagName.toLowerCase()&&"mi"!==node.tagName.toLowerCase()||(tagName="mtext"),mtext=MathJax.HTML.Element(tagName,null,["."]),mje.addElement(mtext)},"∴":function(mje){mje.tryExpression(),mje.addElement(MathJax.HTML.Element("mo",null,["∴"]))}}}}),define("nmcPci/portableLib/equationEditor/mathJaxEditor/recalculate",["exports","nmcPci/portableLib/equationEditor/mathJaxEditor/each","nmcPci/portableLib/equationEditor/mathJaxEditor/id","nmcPci/portableLib/equationEditor/mathJaxEditor/newline"],function(_exports,_each,_id,_newline){"use strict"
;function recalculate(math){var lastParentRect,lastLineRect,cache={},path=[],previous=null,prevData=null,bounding=function(element,id){if(element){if(!cache.hasOwnProperty(id)){var _bounding=element.getBoundingClientRect();_bounding.x=_bounding.left,_bounding.y=_bounding.top,_bounding.y+=window.pageYOffset,cache[id]=_bounding}return cache[id]}},firstBlockBounding=function(){var bounding=document.getElementById(math.id).querySelector(".mjx-block").getBoundingClientRect();return bounding.x=bounding.left,bounding.y=bounding.top,bounding},findBlock=function(element){for(var el=element.parentNode;el;){if("mjx-math"==el.className)return!1
;if("mjx-box"==el.className)return el.setAttribute("id",(0,_id.default)()),el;el=el.parentNode}return!1};return(0,_each.default)(math,function(source){var element=document.getElementById(source.id);if(element){var parentElement,parentRect,parentId,flag,has=source.children.length,last=element.lastElementChild,parent=source.parentNode,tag=source.tagName.toLowerCase(),rect=bounding(element,source.id),data={y:rect.top,height:rect.height,source:source,previous:previous,element:element};switch(parent&&"mrow"!==tag&&(flag=!1,parentId=parent.id,parent===math&&(flag=!0,parentElement=findBlock(element)),
parentElement?parentId=parentElement.id:parentElement=document.getElementById(parent.id),parentRect=bounding(parentElement,parentId),data.y=parentRect.top,data.height=parentElement.clientHeight,flag&&(lastLineRect||(lastLineRect=parentRect),lastParentRect&&parentRect!==lastParentRect&&(lastLineRect=lastParentRect),lastParentRect=parentRect)),prevData&&(prevData.next=source),tag.toLowerCase()){case"mspace":if(!(0,_newline.default)(source))break;var sibling=source.previousElementSibling,prevline=sibling&&(0,_newline.default)(sibling),first=math.firstElementChild===source,other=first?firstBlockBounding():lastLineRect
;data.x=other.x+(first?0:prevline?0:other.width),data.y=other.y,data.height=other.height;break;case"math":var lastChild=source.lastElementChild,dont=lastChild&&(0,_newline.default)(lastChild);lastParentRect?(data.x=lastParentRect.x+(dont?0:lastParentRect.width),data.y=lastParentRect.y,data.height=lastParentRect.height):data.x=(has?rect.width:0)+rect.left;break;case"mrow":data.x=(has?rect.width-last.clientWidth:0)+rect.left;break;default:data.x=rect.left}path.push(data),previous=source,prevData=data}}),path}Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.default=recalculate}),
define("nmcPci/portableLib/equationEditor/mathJaxEditor/view",["exports"],function(_exports){"use strict";function view(){var _wrapper=MathJax.HTML.Element("div",{className:"mje-wrapper"}),container=MathJax.HTML.Element("div",{className:"mje-container"}),input=MathJax.HTML.Element("input",{className:"mje-input"}),jax=null,focused=!1,hover=!1,events={click:null,input:null,code:null},update=function(){focused?container.classList.add("focused"):container.classList.remove("focused")},handleInsideClick=function(e){focused=!0,events.click(e.clientX,e.clientY+window.pageYOffset,e.target),input.focus({preventScroll:!0}),update()},handleMouseEnter=function(){hover=!0
},handleMouseLeave=function(){hover=!1},handleBlur=function(){return hover?(input.focus({preventScroll:!0}),update()):(focused=!1,update())},handleInput=function(e){e.preventDefault(),e.ctrlKey||e.altKey?events.command(e.charCode,e.ctrlKey,e.altKey):events.input(String.fromCharCode(e.which))},handleKeydown=function(e){events.code(e.keyCode)};return _wrapper.appendChild(container),_wrapper.appendChild(input),_wrapper.addEventListener("click",handleInsideClick),container.addEventListener("mouseenter",handleMouseEnter),container.addEventListener("mouseleave",handleMouseLeave),input.addEventListener("blur",handleBlur),
input.addEventListener("keypress",handleInput),input.addEventListener("keydown",handleKeydown),{events:events,wrapper:function(){return _wrapper},value:function(val){return new Promise(function(resolve){if(jax)return jax.Text(val,resolve);container.innerHTML=val;var render=function(){MathJax.Hub.Queue(["Typeset",MathJax.Hub,container,function(){jax=MathJax.Hub.getAllJax(input)[0],resolve()}])};MathJax.isReady?render():MathJax.Hub.Register.StartupHook("End",function(){setTimeout(render,1e3)})})},removeClass:function(className){for(var elements=_wrapper.getElementsByClassName(className);elements.length>0;)elements[0].classList.remove(className)},
draw:function(data){if(data){this.removeClass("editor-cursor"),this.removeClass("end-of-line"),"newline"!==data.source.getAttribute("linebreak")&&"math"!==data.source.tagName.toLowerCase()||!data.previous||"mrow"===data.previous.tagName.toLowerCase()||"false"===data.previous.getAttribute("selectable")?data.element.classList.add("editor-cursor"):$(_wrapper).find("#"+data.previous.id).addClass("editor-cursor end-of-line");container.parentElement.parentElement.scrollLeft=data.element.offsetLeft+data.element.offsetWidth;var elementRect=data.element.getBoundingClientRect();input.style.left="".concat(elementRect.x,"px"),
input.style.top="".concat(elementRect.y,"px")}},focus:function(){focused=!0,input.focus({preventScroll:!0}),update()}}}Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.default=view}),
define("nmcPci/portableLib/equationEditor/mathJaxEditor/editor",["exports","taoQtiItem/portableLib/jquery_2_1_1","nmcPci/portableLib/equationEditor/mathJaxEditor/add","nmcPci/portableLib/equationEditor/mathJaxEditor/backspace","nmcPci/portableLib/equationEditor/mathJaxEditor/del","nmcPci/portableLib/equationEditor/mathJaxEditor/display","nmcPci/portableLib/equationEditor/mathJaxEditor/each","nmcPci/portableLib/equationEditor/mathJaxEditor/operators","nmcPci/portableLib/equationEditor/mathJaxEditor/recalculate","nmcPci/portableLib/equationEditor/mathJaxEditor/view"],function(_exports,$,_add,_backspace,_del,_display,_each,_operators,_recalculate,_view){
"use strict";function mathJaxEditor(target){if(!MathJax)throw new Error("mathJaxEditor: MathJax not found. Ensure that MathJax is loaded before calling mathJaxEditor.");var api={},math=MathJax.HTML.Element("math"),ui=(0,_view.default)(),current=math,pos=null,path=null,readonly=!1,allowedTags=[],allowNewline=!1,allowText=!0,hasChanged=!1,historyPointer=0,history=[],draw=function(){pos=path.find(function(predicate){return predicate.source===current}),ui.draw(pos)},update=function(to,math){return to&&(current=to),math?ui.value((0,_display.default)(math)).then(function(){path=(0,_recalculate.default)(math),draw()}):draw()},canSelect=function(el){
return"false"!==el.getAttribute("selectable")&&!(readonly&&!el.getAttribute("editable")&&!$(el).parents("[editable=true]").length)},findSelectable=function(el,to){for(;el;){if($("#"+el.id).removeClass("soft"),$(math).find("#"+el.id).removeClass("soft"),canSelect(el))return el;var _this=path.find(function(p){return p.source===el});if(!_this)return;el=_this[to]}},add=function(what,source){storeState(),(0,_add.default)(what,source),"function"==typeof api.onChange&&api.onChange(math)},storeState=function(){history=history.slice(0,historyPointer),history.push({math:math.outerHTML,current:current.id}),historyPointer++,hasChanged=!0},restoreState=function(pointer){
var state=history[pointer],parser=new DOMParser,doc=parser.parseFromString(state.math,"text/html");math=doc.body.firstElementChild,math.parentNode.removeChild(math);var current=$(math).find("#"+state.current)[0];update(current||math,math)},canInput=function(tag){if(!readonly)return!0;if(tag&&allowedTags.length&&-1===allowedTags.indexOf(tag))return!1;for(var curr=current;curr;){if(curr.hasAttribute("editable"))return!0;curr=curr.parentNode}return!1},getCurrentNode=function(){
return"math"===current.tagName.toLowerCase()?current.lastElementChild:"mrow"===current.tagName.toLowerCase()?current.children.length?current.lastElementChild:current:current.previousElementSibling||current.parentNode&&current.parentNode.previousElementSibling},getTagName=function(defaultName,notEmpty){var node,tagName,selectable;if(allowText){if(node=getCurrentNode(),!notEmpty&&!node)return"mtext";if(node){if(tagName=node.tagName.toLowerCase(),selectable="true"===node.getAttribute("selectable"),"mtext"===tagName||"mspace"===tagName||"mover"===tagName&&!selectable&&!notEmpty)return"mtext"
;if("."===node.textContent&&node.previousSibling&&"mi"===node.previousSibling.tagName.toLowerCase())return"mtext"}}return defaultName},tryExpression=function(){var node,text,$node,$newNode,tagName,mspace,nodesToChange=[],chars=3,newNodes=[],backTo=0,dollarChars=0;if(allowText){for(node=getCurrentNode();chars&&node&&"mtext"===node.tagName.toLowerCase();){if(text=node.textContent,text.match(/[a-zA-Z!]/)){if(chars<=1){nodesToChange.splice(backTo);break}chars--}else if("."===text||","===text){if(3!==chars||node.previousElementSibling&&!node.previousElementSibling.textContent.match(/\d/))break}else if("$"===text||"%"===text||"?"===text)chars--,
backTo=nodesToChange.length+1;else{if(!text.match(/\d/))break;chars=1,backTo=nodesToChange.length+1}nodesToChange.push(node),node=node.previousElementSibling}if(nodesToChange.length){!0,node&&"mtext"===node.tagName.toLowerCase()&&node.textContent.trim().length&&(mspace=MathJax.HTML.Element("mspace"),mspace.setAttribute("width","0.5em"),mspace.setAttribute("height","1em"),$(mspace).insertBefore(nodesToChange[nodesToChange.length-1]));for(var i=0;i<nodesToChange.length;i++){if($node=$(nodesToChange[i]),text=$node.html(),text.match(/[a-zA-Z]/))tagName="mi";else if(text.match(/[\d.,]/))tagName="mn";else if("$"===text){if(i!==nodesToChange.length-1){
dollarChars++,nodesToChange[i].remove();continue}tagName="mi"}else tagName="mo";$newNode=$("<"+tagName+"/>").html($node.html()),newNodes.unshift($newNode.get(0)),$node.replaceWith($newNode)}for(;dollarChars--;)$newNode=$(MathJax.HTML.Element("mi",null,["$"])),$newNode.insertBefore(newNodes[0]),newNodes.unshift($newNode.get(0))}}return newNodes},moverChars=["→","↔","¯"],tryMover=function(parentNode){return!!(parentNode&&parentNode.childElementCount>=2&&(parentNode=parentNode.parentNode)&&parentNode.nextSibling&&moverChars.indexOf(parentNode.nextSibling.textContent)>=0)&&api.handleMover()},geometryChars={"∠":3,"△":3,"▱":4,"⊙":3},tryGeometryChar=function(){
var char,count,mo,prev,node=getCurrentNode(),parentNode=node?node.parentNode:null;return!!(parentNode&&parentNode.previousSibling&&(prev=parentNode.previousSibling,char=prev.textContent,(count=geometryChars[char])&&parentNode.textContent.match(/[a-zA-Z]/)&&parentNode.textContent.length>=count))&&(mo=MathJax.HTML.Element("mo",null,["("]),"∠"===char&&prev.previousSibling&&"m"===prev.previousSibling.textContent&&(prev=prev.previousSibling),$(mo).insertBefore(prev),mo=MathJax.HTML.Element("mo",null,[")"]),$(mo).insertAfter(parentNode),api.setCurrent(mo.nextSibling),!0)},operator=function(c){var tagName=getTagName("mo");if(canInput(tagName)){
var mo=MathJax.HTML.Element(tagName,null,[c]);add(mo,current),update(null,math)}},mathIdentifier=function(c,isTool){tryExpression();var tagName=isTool?"mi":getTagName("mi");if(canInput(tagName)){var mo=MathJax.HTML.Element(tagName,null,[c]);add(mo,current),update(null,math)}},binaryOperator=function(o,isTool){var tagName,mo,mrow;tryExpression(),tagName=isTool?"mo":getTagName("mo",!0),canInput(tagName)&&(mo=MathJax.HTML.Element(tagName,null,[o]),add(mo,current),"mo"===tagName?(mrow=MathJax.HTML.Element("mrow"),add(mrow,current),update(mrow,math)):update(null,math))},relation=function(o,isTool,dontTry){var tagName,mo,mrow,node,char;dontTry||tryExpression(),
tagName=isTool?"mo":getTagName("mo",!dontTry),canInput(tagName)&&(node=getCurrentNode(),"mo"===tagName&&(!node||"mtext"===node.tagName.toLowerCase()||readonly&&"ee-gap"===node.className)&&(mrow=MathJax.HTML.Element("mrow"),add(mrow,current)),char=_.isArray(o)?"mtext"===tagName?o[0]:o[1]:o,mo=MathJax.HTML.Element(tagName,null,[char]),"mrow"===current.tagName.toLowerCase()&&!current.children.length&&readonly&&"ee-gap"!==current.className&&(current=math),add(mo,current),"mo"===tagName?(mrow=MathJax.HTML.Element("mrow"),add(mrow,current),update(mrow,math)):update(null,math))},group=function(open,close,onlyMath){var tagName,mrow,emptyRow;tryExpression(),
tagName=getTagName("mo",!onlyMath),canInput(tagName)&&("mo"===tagName?(mrow=MathJax.HTML.Element("mrow"),mrow.appendChild(MathJax.HTML.Element(tagName,null,[open])),emptyRow=MathJax.HTML.Element("mrow"),mrow.appendChild(emptyRow),mrow.appendChild(MathJax.HTML.Element(tagName,{className:"soft"},[close])),add(mrow,current),update(emptyRow,math)):(add(MathJax.HTML.Element(tagName,null,[open]),current),update(null,math)))},onlyText=function(c){var mtext,tagName=getTagName("mo");if(canInput(tagName))if("mo"!==tagName){var mo=MathJax.HTML.Element(tagName,null,[c]);add(mo,current),update(null,math)
}else allowText&&current&&current.parentNode&&(mtext=MathJax.HTML.Element("mtext"),add(mtext,math),update(math,math))},reverseString=function(s){return s.split("").reverse().join("")},functions={};if(functions[reverseString("sin")]={type:"func",value:"sin"},functions[reverseString("sec")]={type:"func",value:"sec"},functions[reverseString("cos")]={type:"func",value:"cos"},functions[reverseString("csc")]={type:"func",value:"csc"},functions[reverseString("tan")]={type:"func",value:"tan"},functions[reverseString("cot")]={type:"func",value:"cot"},functions[reverseString("pi")]={type:"const",value:"π"},api.raw=function(){return math},api.path=function(){
return path},api.version=function(){return"1.0.2"},api.right=function(){update(findSelectable(pos.next,"next"))},api.left=function(){update(findSelectable(pos.previous,"previous"))},api.del=function(){canInput()&&(storeState(),update((0,_del.default)(math,current,null,readonly),math),"function"==typeof api.onChange&&api.onChange(math))},api.backspace=function(){canInput()&&(storeState(),update((0,_backspace.default)(math,current,readonly),math),"function"==typeof api.onChange&&api.onChange(math))},api.newline=function(){var linebreak,mspace,node;if(allowNewline&&canInput()&&(current.parentNode===math||current===math)){if(storeState(),
linebreak=MathJax.HTML.Element("mspace"),linebreak.setAttribute("linebreak","newline"),current===math)node=math.lastElementChild,$(linebreak).insertAfter(node);else{for(node=current;node.parentNode!==math;)node=node.parentNode;node.nextSibling&&node.nextSibling.textContent?$(linebreak).insertBefore(node):$(linebreak).insertAfter(node)}node.nextSibling&&(mspace=MathJax.HTML.Element("mtext"),$(mspace).insertAfter(linebreak)),update(mspace,math)}},api.number=function(n){var tagName=getTagName("mn");if(canInput(tagName)){var mn=MathJax.HTML.Element(tagName,null,[n]);add(mn,current),update(null,math)}},api.whitespace=function(){
if(canInput("mspace")&&(!current||"mrow"!==current.tagName.toLowerCase()||current.children.length)){var mspace=MathJax.HTML.Element("mspace");if(mspace.setAttribute("width","0.5em"),mspace.setAttribute("height","1em"),current.parentNode&&"math"!==current.parentNode.tagName.toLowerCase()){for(;current&&"math"!==current.parentNode.tagName.toLowerCase();)current=current.parentNode;current=current.nextSibling||math}add(mspace,current),update(null,math)}},api.identifier=function(c,isTool){var mi,mrow,func,keys,key,tagName=isTool?"mi":getTagName("mi"),node=getCurrentNode(),text=c.toLowerCase(),nodes=[],parentNode=node?node.parentNode:null;if(canInput(tagName)){
if("mi"===tagName&&!tryMover(parentNode)&&!tryGeometryChar()){for(;node&&"mi"===node.tagName.toLowerCase();)text+=node.textContent.toLowerCase(),nodes.push(node),node=node.previousSibling;if(text.length){keys=_.keys(functions);for(var i=0;i<keys.length;i++)if(key=keys[i],0===text.indexOf(key)){func=functions[key];for(var j=0;j<key.length-1;j++)nodes[j].remove();return nodes.length>j&&("mi"!==(tagName=nodes[j].tagName.toLowerCase())&&"mn"!==tagName||api.whitespace()),mi=MathJax.HTML.Element("mi",{},[func.value]),add(mi,current),"func"===func.type&&(mrow=MathJax.HTML.Element("mrow"),add(mrow,current)),void update(mrow,math)}}}
mi=MathJax.HTML.Element(tagName,null,[c]),add(mi,current),update(null,math)}},api.handleMover=function(){for(var bkt,node=getCurrentNode(),moverNode=null;node;){if("mover"===node.tagName.toLowerCase()){moverNode=node;break}node=node.parentNode}return!!moverNode&&($(MathJax.HTML.Element("mo",{},["("])).insertBefore(moverNode),bkt=MathJax.HTML.Element("mo",{},[")"]),$(bkt).insertAfter(moverNode),api.setCurrent(bkt.nextSibling),!0)},api.operator=function(char,isTool){
return _operators.binary.hasOwnProperty(char)?binaryOperator(_operators.binary[char],isTool):_operators.relations.hasOwnProperty(char)?relation(_operators.relations[char],isTool):_operators.mathChars.hasOwnProperty(char)?mathIdentifier(_operators.mathChars[char],isTool):_operators.onlyMathRelations.hasOwnProperty(char)?relation(_operators.onlyMathRelations[char],isTool,!0):_operators.groups.hasOwnProperty(char)?group(char,_operators.groups[char],isTool):_operators.onlyMathGroups.hasOwnProperty(char)?group(char,_operators.onlyMathGroups[char],!0):_operators.onlyText.hasOwnProperty(char)?onlyText(_operators.onlyText[char]):_operators.custom.hasOwnProperty(char)?_operators.custom[char](this,isTool):operator(char)
},api.tryExpression=tryExpression,api.getTagName=getTagName,api.getCurrentNode=getCurrentNode,api.setCurrent=function(value){current=value||math},api.getCurrent=function(){return current},api.addElement=function(element,row){(0,_each.default)(element,function(el){("mrow"!==el.tagName.toLowerCase()||el.children.length)&&(el.hasAttribute("selectable")||el.setAttribute("selectable",!1))}),storeState(),(0,_add.default)(element,current),update(row||null,math),"function"==typeof api.onChange&&api.onChange(math)},api.root=function(){if(canInput("mroot")){var mroot=MathJax.HTML.Element("mroot"),mrow1=MathJax.HTML.Element("mrow"),mrow2=MathJax.HTML.Element("mrow")
;mroot.appendChild(mrow1),mroot.appendChild(mrow2),add(mroot,current),update(mrow1,math)}},api.get=function(){var output=math.cloneNode(!0);return(0,_each.default)(output,function(source){source.removeAttribute("id"),source.removeAttribute("selectable")}),output.outerHTML},api.set=function(dom){var $mrow,parser=new DOMParser,doc=parser.parseFromString(dom,"text/html");math=doc.body.firstElementChild,math.parentNode.removeChild(math),$mrow=$(math).find("mrow[editable=true]"),update($mrow.length?$mrow[0]:math,math)},api.readonly=function(val){readonly=val},api.allowedTags=function(val){allowedTags=val},api.allowNewline=function(val){allowNewline=val},
api.allowText=function(val){return void 0!==val&&(allowText=val),allowText},api.focus=function(){ui.focus()},api.undo=function(){hasChanged&&(storeState(),hasChanged=!1,historyPointer--),history.length>=historyPointer&&historyPointer>0&&restoreState(--historyPointer)},api.redo=function(){history.length>historyPointer+1&&restoreState(++historyPointer)},api.onChange=null,ui.events.click=function(x,y,target){if(target){var data;if(target.parentElement.classList.contains("mje-placeholder")&&(target=target.parentElement),data=_.find(path||[],function(data){return data.element==target||data.element==target.parentElement
}))return void update(findSelectable(data.source,"next"))}var smaller=1/0,candidate=null;_.forEach(path||[],function(data){var p1x=data.x,p1y=data.y,p2y=p1y+data.height,d=Math.abs(p1x-x);p1y<=y&&y<=p2y&&smaller>d&&(smaller=d,candidate=data)}),candidate&&update(candidate.source)},ui.events.command=function(charCode,ctrlKey,altKey){26===charCode&&ctrlKey&&api.undo(),25===charCode&&ctrlKey&&api.redo()},ui.events.input=function(char){return char.match(/\d/)?api.number(char):char.match(/[a-zA-Z]/)?api.identifier(char):" "===char?api.whitespace():api.operator(char)},ui.events.code=function(code){switch(code){case 8:return api.backspace(readonly);case 13:
return api.newline();case 37:return api.left();case 39:return api.right();case 46:return api.del(readonly)}},"string"==typeof target&&(target=document.querySelector(target)),!target||!target.parentNode)throw new Error("mathJaxEditor: target element not found.");return target.parentNode.replaceChild(ui.wrapper(),target),MathJax.Hub.processSectionDelay=0,update(math,math),api}Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.default=mathJaxEditor}),define("nmcPci/portableLib/equationEditor/tools/grade",[],function(){return{grade_3_5:"grade_3_5",grade_6_8:"grade_6_8",grade_9_12:"grade_9_12"}}),
define("nmcPci/portableLib/equationEditor/tools/keyboardBehavior",[],function(){return{numbersAndFraction:"NumbersAndFraction",numbersAndMath:"NumbersAndMath",numbersMathAndText:"NumbersMathAndText"}}),define("nmcPci/portableLib/equationEditor/tools/numbersAndFraction",[],function(){return["fraction","mixedNumber"]}),define("nmcPci/portableLib/equationEditor/tools/numbersAndMath",["nmcPci/portableLib/equationEditor/tools/grade"],function(grade){var tools={};return tools[grade.grade_3_5]=[{toolType:"operator",value:"+",tooltip:"plus sign"},{toolType:"operator",value:"−",tooltip:"minus sign"},{toolType:"operator",value:"×",tooltip:"times sign"},{
toolType:"operator",value:"÷",tooltip:"division sign"},"fraction","mixedNumber",{toolType:"operator",value:"=",tooltip:"equal"},{toolType:"operator",value:"<",tooltip:"less than"},{toolType:"operator",value:">",tooltip:"greater than"},"parenthesis","bracket",{toolType:"operator",value:"$",tooltip:"dollar sign"}],tools[grade.grade_6_8]=[{toolType:"operator",value:"+",tooltip:"plus sign"},{toolType:"operator",value:"−",tooltip:"minus sign"},{toolType:"operator",value:"×",tooltip:"times sign"},{toolType:"operator",value:"÷",tooltip:"division sign"},"fraction","mixedNumber","exponent","sqrt","cubeRoot",{toolType:"operator",value:"=",tooltip:"equal"
},"parenthesis",{toolType:"identifier",value:"%",tooltip:"percent sign"},{toolType:"operator",value:"±",tooltip:"plus minus sign"},"negative",{toolType:"operator",value:"·",tooltip:"times dot"},{toolType:"operator",value:"⁄",tooltip:"division slash"},"bracket","absolute",{toolType:"operator",value:"<",tooltip:"less than"},{toolType:"operator",value:">",tooltip:"greater than"},{toolType:"operator",value:"≤",tooltip:"less than or equal"},{toolType:"operator",value:"≥",tooltip:"greater than or equal"},{toolType:"operator",value:"°",tooltip:"degree sign"},{toolType:"operator",value:"π",tooltip:"constant pi"}],tools[grade.grade_9_12]=[{toolType:"operator",
value:"+",tooltip:"plus sign"},{toolType:"operator",value:"−",tooltip:"minus sign"},{toolType:"operator",value:"×",tooltip:"times sign"},{toolType:"operator",value:"÷",tooltip:"division sign"},"fraction","mixedNumber","exponent","sqrt","cubeRoot",{toolType:"operator",value:"=",tooltip:"equal"},"parenthesis",{toolType:"identifier",value:"%",tooltip:"percent sign"},{toolType:"operator",value:"±",tooltip:"plus minus sign"},"negative",{toolType:"operator",value:"·",tooltip:"times dot"},{toolType:"operator",value:"⁄",tooltip:"division slash"},"bracket","absolute",{toolType:"operator",value:"<",tooltip:"less than"},{toolType:"operator",value:">",
tooltip:"greater than"},{toolType:"operator",value:"≤",tooltip:"less than or equal"},{toolType:"operator",value:"≥",tooltip:"greater than or equal"},"root","log",{toolType:"operator",value:"°",tooltip:"degree sign"},{toolType:"operator",value:"π",tooltip:"constant pi"},{toolType:"identifier",value:"∞",tooltip:"infinity"},{toolType:"identifier",value:"i",tooltip:"imaginary i"},{toolType:"identifier",value:"e",tooltip:"exponential e"},{toolType:"identifier",value:"θ",tooltip:"theta"},"sin","cos","tan","inverseSin","inverseCos","inverseTan"],tools}),
define("nmcPci/portableLib/equationEditor/tools/numbersMathAndText",["nmcPci/portableLib/equationEditor/tools/grade"],function(grade){var tools={};return tools[grade.grade_3_5]=[{id:"mathsymbols",title:"Math symbols",tools:[{toolType:"operator",value:"+",tooltip:"plus sign"},{toolType:"operator",value:"−",tooltip:"minus sign"},{toolType:"operator",value:"×",tooltip:"times sign"},{toolType:"operator",value:"÷",tooltip:"division sign"},"fraction","mixedNumber","parenthesis","bracket",{toolType:"operator",value:"=",tooltip:"equal"},{toolType:"operator",value:"<",tooltip:"less than"},{toolType:"operator",value:">",tooltip:"greater than"},{toolType:"operator",
value:"≠",tooltip:"not equal"},{toolType:"operator",value:"$",tooltip:"dollar sign"},{toolType:"operator",value:"°",tooltip:"degree sign"},{toolType:"operator",value:"?",tooltip:"question mark"}]}],tools[grade.grade_6_8]=[{id:"mathsymbols",title:"Math symbols",tools:[{toolType:"operator",value:"+",tooltip:"plus sign"},{toolType:"operator",value:"−",tooltip:"minus sign"},{toolType:"operator",value:"×",tooltip:"times sign"},{toolType:"operator",value:"÷",tooltip:"division sign"},{toolType:"operator",value:"±",tooltip:"plus minus sign"},"negative",{toolType:"operator",value:"·",tooltip:"times dot"},{toolType:"operator",value:"⁄",tooltip:"division slash"},{
toolType:"operator",value:"=",tooltip:"equal"},{toolType:"operator",value:"≠",tooltip:"not equal"},"fraction","mixedNumber","exponent","sqrt","cubeRoot",{toolType:"operator",value:"π",tooltip:"constant pi"},"parenthesis",{toolType:"operator",value:"°",tooltip:"degree sign"},"absolute"]},{id:"relations",title:"Relations",tools:_.map([["=","equal"],["≠","not equal"],["∼","similar"],["≁","not similar"],["<","less than"],[">","greater than"],["≈","approximately equal"],["≉","not approximately equal"],["≤","less than or equal"],["≥","greater than or equal"],["≅","congruent"],["≇","not congruent"]],function(c){return{toolType:"operator",value:c[0],tooltip:c[1]}})
},{id:"geometry",title:"Geometry",tools:["ray","line","lineSegment",{toolType:"operator",value:"∥",tooltip:"parallel"},{toolType:"operator",value:"⊥",tooltip:"perpendicular"},{toolType:"operator",value:"∠",tooltip:"angle"},"angleMeasure",{toolType:"operator",value:"△",tooltip:"triangle"},{toolType:"operator",value:"▱",tooltip:"parallelogram"},{toolType:"operator",value:"⊙",tooltip:"circle"},{toolType:"identifier",value:"'",tooltip:"prime"}]}],tools[grade.grade_9_12]=[{id:"mathsymbols",title:"Math symbols",tools:[{toolType:"operator",value:"+",tooltip:"plus sign"},{toolType:"operator",value:"−",tooltip:"minus sign"},{toolType:"operator",value:"×",
tooltip:"times sign"},{toolType:"operator",value:"÷",tooltip:"division sign"},{toolType:"operator",value:"±",tooltip:"plus minus sign"},"negative",{toolType:"operator",value:"·",tooltip:"times dot"},{toolType:"operator",value:"⁄",tooltip:"division slash"},{toolType:"operator",value:"=",tooltip:"equal"},{toolType:"operator",value:"≠",tooltip:"not equal"},"fraction","mixedNumber","exponent","sqrt","cubeRoot","root","exponential","ln","log","logarithm",{toolType:"operator",value:"π",tooltip:"constant pi"},{toolType:"identifier",value:"i",tooltip:"imaginary i"},{toolType:"identifier",value:"e",tooltip:"exponential e"},{toolType:"identifier",value:"∞",
tooltip:"infinity"},{toolType:"operator",value:"°",tooltip:"degree sign"},"parenthesis"]},{id:"relations",title:"Relations",tools:_.map([["=","equal"],["≠","not equal"],["∼","similar"],["≁","not similar"],["<","less than"],[">","greater than"],["≈","approximately equal"],["≉","not approximately equal"],["≤","less than or equal"],["≥","greater than or equal"],["≅","congruent"],["≇","not congruent"],["∴","therefore"]],function(c){return{toolType:"operator",value:c[0],tooltip:c[1]}})},{id:"geometry",title:"Geometry",tools:["ray","line","lineSegment","arc",{toolType:"operator",value:"∥",tooltip:"parallel"},{toolType:"operator",value:"⊥",tooltip:"perpendicular"
},{toolType:"operator",value:"∠",tooltip:"angle"},"angleMeasure",{toolType:"operator",value:"△",tooltip:"triangle"},{toolType:"operator",value:"▱",tooltip:"parallelogram"},{toolType:"operator",value:"⊙",tooltip:"circle"},"prime"]},{id:"groups",title:"Groups",tools:["parenthesis","bracket","brace","absolute","openInterval","closedInterval","openClosedInterval","closedOpenInterval"]},{id:"trigonometry",title:"Trigonometry",tools:["sin","secant","inverseSin","inverseSecant","cos","cosecant","inverseCos","inverseCosecant","tan","cotangent","inverseTan","inverseCotangent"]},{id:"statistics",title:"Statistics",tools:[{toolType:"identifier",value:"μ",
tooltip:"population mean mu"},{toolType:"identifier",value:"σ",tooltip:"standard deviation sigma"},"overBar","overBarBlock","superscript","subscript","factorial","sum"]},{id:"greek",title:"Greek",tools:_.map([["α","small alpha"],["β","small beta"],["γ","small gamma"],["δ","small delta"],["θ","small theta"],["π","small pi"]],function(c){return{toolType:"identifier",value:c[0],tooltip:c[1]}})}],tools}),define("nmcPci/portableLib/equationEditor/tools/availableTools",["taoQtiItem/portableLib/jquery_2_1_1"],function($){return{number:{fn:function(mje,n){mje.number(n)}},operator:{fn:function(mje,o){mje.operator(o,!0)}},identifier:{fn:function(mje,i){
mje.identifier(i,!0)}},sqrt:{icon:"sqrt",tooltip:"square root",desc:"Square root",fn:function(mje){var msqrt=MathJax.HTML.Element("msqrt"),mrow=MathJax.HTML.Element("mrow");msqrt.appendChild(mrow),mje.tryExpression(),mje.addElement(msqrt,mrow)}},sum:{label:"Σ",tooltip:"summation sigma",fn:function(mje){var mrow,mrow1,mrow2,munderover=MathJax.HTML.Element("munderover");munderover.appendChild(MathJax.HTML.Element("mo",{},["Σ"])),mrow1=MathJax.HTML.Element("mrow"),mrow1.appendChild(MathJax.HTML.Element("mi",{style:{fontSize:"60%"}},["i"])),mrow1.appendChild(MathJax.HTML.Element("mo",{style:{fontSize:"60%"}},["="])),mrow1.appendChild(MathJax.HTML.Element("mn",{
style:{fontSize:"60%"}},["1"])),mrow2=MathJax.HTML.Element("mrow"),mrow2.appendChild(MathJax.HTML.Element("mi",{style:{fontSize:"60%"}},["n"])),munderover.appendChild(mrow1),munderover.appendChild(mrow2),mje.addElement(munderover),mrow=MathJax.HTML.Element("mrow"),mje.addElement(mrow,mrow)}},fraction:{icon:"frac",tooltip:"fraction",fn:function(mje){var mfrac=MathJax.HTML.Element("mfrac"),mrow1=MathJax.HTML.Element("mrow"),mrow2=MathJax.HTML.Element("mrow");mfrac.appendChild(mrow1),mfrac.appendChild(mrow2),mje.addElement(mfrac,mrow1)}},mixedNumber:{icon:"mxf",tooltip:"mixed number",fn:function(mje){
var mrow=MathJax.HTML.Element("mrow"),mrow1=MathJax.HTML.Element("mrow"),mfrac=MathJax.HTML.Element("mfrac"),mrow2=MathJax.HTML.Element("mrow"),mrow3=MathJax.HTML.Element("mrow");mrow.appendChild(mrow1),mfrac.appendChild(mrow2),mfrac.appendChild(mrow3),mrow.appendChild(mfrac),mje.addElement(mrow,mrow1)}},parenthesis:{label:"(·)",tooltip:"parenthesis",fn:function(mje){var mrow=MathJax.HTML.Element("mrow"),mo1=MathJax.HTML.Element("mo",{},["("]),mrow1=MathJax.HTML.Element("mrow"),mo2=MathJax.HTML.Element("mo",{className:"soft"},[")"]);mrow.appendChild(mo1),mrow.appendChild(mrow1),mrow.appendChild(mo2),mje.addElement(mrow,mrow1)}},bracket:{label:"[·]",
tooltip:"bracket",fn:function(mje){var mrow=MathJax.HTML.Element("mrow"),mo1=MathJax.HTML.Element("mo",{},["["]),mrow1=MathJax.HTML.Element("mrow"),mo2=MathJax.HTML.Element("mo",{className:"soft"},["]"]);mrow.appendChild(mo1),mrow.appendChild(mrow1),mrow.appendChild(mo2),mje.addElement(mrow,mrow1)}},brace:{label:"{·}",tooltip:"brace",fn:function(mje){var mrow=MathJax.HTML.Element("mrow"),mo1=MathJax.HTML.Element("mo",{},["{"]),mrow1=MathJax.HTML.Element("mrow"),mo2=MathJax.HTML.Element("mo",{className:"soft"},["}"]);mrow.appendChild(mo1),mrow.appendChild(mrow1),mrow.appendChild(mo2),mje.addElement(mrow,mrow1)}},absolute:{label:"∣·∣",tooltip:"absolute value",
fn:function(mje){var mrow=MathJax.HTML.Element("mrow"),mo1=MathJax.HTML.Element("mo",{},["|"]),mrow1=MathJax.HTML.Element("mrow"),mo2=MathJax.HTML.Element("mo",{className:"soft"},["|"]);mrow.appendChild(mo1),mrow.appendChild(mrow1),mrow.appendChild(mo2),mje.addElement(mrow,mrow1)}},openInterval:{label:"(·,·)",tooltip:"open interval",fn:function(mje){var mrow=MathJax.HTML.Element("mrow"),mo1=MathJax.HTML.Element("mo",{},["("]),mrow1=MathJax.HTML.Element("mrow"),mrow2=MathJax.HTML.Element("mrow");mrow1.appendChild(mrow2),mrow1.appendChild(MathJax.HTML.Element("mo",{},[","])),mrow1.appendChild(MathJax.HTML.Element("mrow"))
;var mo2=MathJax.HTML.Element("mo",{},[")"]);mrow.appendChild(mo1),mrow.appendChild(mrow1),mrow.appendChild(mo2),mje.addElement(mrow,mrow2)}},closedInterval:{label:"[·,·]",tooltip:"closed interval",fn:function(mje){var mrow=MathJax.HTML.Element("mrow"),mo1=MathJax.HTML.Element("mo",{},["["]),mrow1=MathJax.HTML.Element("mrow"),mrow2=MathJax.HTML.Element("mrow");mrow1.appendChild(mrow2),mrow1.appendChild(MathJax.HTML.Element("mo",{},[","])),mrow1.appendChild(MathJax.HTML.Element("mrow"));var mo2=MathJax.HTML.Element("mo",{},["]"]);mrow.appendChild(mo1),mrow.appendChild(mrow1),mrow.appendChild(mo2),mje.addElement(mrow,mrow2)}},openClosedInterval:{label:"(·,·]",
tooltip:"open-closed interval",fn:function(mje){var mrow=MathJax.HTML.Element("mrow"),mo1=MathJax.HTML.Element("mo",{},["("]),mrow1=MathJax.HTML.Element("mrow"),mrow2=MathJax.HTML.Element("mrow");mrow1.appendChild(mrow2),mrow1.appendChild(MathJax.HTML.Element("mo",{},[","])),mrow1.appendChild(MathJax.HTML.Element("mrow"));var mo2=MathJax.HTML.Element("mo",{},["]"]);mrow.appendChild(mo1),mrow.appendChild(mrow1),mrow.appendChild(mo2),mje.addElement(mrow,mrow2)}},closedOpenInterval:{label:"[·,·)",tooltip:"closed-open interval",fn:function(mje){
var mrow=MathJax.HTML.Element("mrow"),mo1=MathJax.HTML.Element("mo",{},["["]),mrow1=MathJax.HTML.Element("mrow"),mrow2=MathJax.HTML.Element("mrow");mrow1.appendChild(mrow2),mrow1.appendChild(MathJax.HTML.Element("mo",{},[","])),mrow1.appendChild(MathJax.HTML.Element("mrow"));var mo2=MathJax.HTML.Element("mo",{},[")"]);mrow.appendChild(mo1),mrow.appendChild(mrow1),mrow.appendChild(mo2),mje.addElement(mrow,mrow2)}},exponent:{label:'<span style="font-style:italic;">y<span class="sup">x</span></span>',tooltip:"exponent",fn:function(mje){mje.operator("^")}},ln:{label:"ln",tooltip:"natural logarithm",fn:function(mje){var mrow=MathJax.HTML.Element("mrow")
;mrow.appendChild(MathJax.HTML.Element("mi",{},["ln"])),mrow.appendChild(MathJax.HTML.Element("mo"));var mrow1=MathJax.HTML.Element("mrow");mrow.appendChild(mrow1),mje.addElement(mrow,mrow1)}},exponential:{label:'<span style="font-style:italic;">e<span class="sup">x</span></span>',tooltip:"exponential",fn:function(mje){var msup=MathJax.HTML.Element("msup"),mi=MathJax.HTML.Element("mi",{},["e"]),mrow=MathJax.HTML.Element("mrow");msup.appendChild(mi),msup.appendChild(mrow),mje.addElement(msup,mrow)}},subscript:{label:'<span style="font-style:italic;">x<span class="sub">i</span></span>',tooltip:"subscript",fn:function(mje){mje.operator("_")}},root:{icon:"root",
tooltip:"general root",fn:function(mje){var root=MathJax.HTML.Element("mroot"),mrow1=MathJax.HTML.Element("mrow"),mrow2=MathJax.HTML.Element("mrow");root.appendChild(mrow1),root.appendChild(mrow2),mje.tryExpression(),mje.addElement(root,mrow1)}},cubeRoot:{icon:"rt-3",tooltip:"cube root",fn:function(mje){var root=MathJax.HTML.Element("mroot"),mrow=MathJax.HTML.Element("mrow"),number=MathJax.HTML.Element("mn",{},["3"]);root.appendChild(mrow),root.appendChild(number),mje.tryExpression(),mje.addElement(root,mrow)}},negative:{label:'<span><span class="sup">−</span></span>',tooltip:"negative sign",fn:function(mje){mje.tryExpression();var node=mje.getCurrentNode()
;if(node&&"mtext"!==node.tagName.toLowerCase())mje.operator("-",!0);else{var msup=MathJax.HTML.Element("msup"),space=MathJax.HTML.Element("mo"),mo=MathJax.HTML.Element("mo",{},["-"]);msup.appendChild(space),msup.appendChild(mo),mje.addElement(msup);var mrow=MathJax.HTML.Element("mrow");mje.addElement(mrow,mrow)}}},ray:{label:"→",tooltip:"ray",fn:function(mje){var mover=MathJax.HTML.Element("mover"),mrow=MathJax.HTML.Element("mrow");mje.handleMover(),mrow.appendChild(MathJax.HTML.Element("mo"));var mrow1=MathJax.HTML.Element("mrow");mrow.appendChild(mrow1),mover.appendChild(mrow),mover.appendChild(MathJax.HTML.Element("mo",{},["→"])),
mje.addElement(mover,mrow1)}},line:{label:"↔",tooltip:"line",fn:function(mje){var mover=MathJax.HTML.Element("mover"),mrow=MathJax.HTML.Element("mrow");mje.handleMover(),mrow.appendChild(MathJax.HTML.Element("mo"));var mrow1=MathJax.HTML.Element("mrow");mrow.appendChild(mrow1),mover.appendChild(mrow),mover.appendChild(MathJax.HTML.Element("mo",{},["↔"])),mje.addElement(mover,mrow1)}},lineSegment:{label:"¯",tooltip:"line segment",fn:function(mje){var mover=MathJax.HTML.Element("mover"),mrow=MathJax.HTML.Element("mrow");mje.handleMover(),mrow.appendChild(MathJax.HTML.Element("mo"));var mrow1=MathJax.HTML.Element("mrow");mrow.appendChild(mrow1),
mover.appendChild(mrow),mover.appendChild(MathJax.HTML.Element("mo",{},["¯"])),mje.addElement(mover,mrow1)}},arc:{label:"⁀",tooltip:"arc",fn:function(mje){var mover=MathJax.HTML.Element("mover"),mrow=MathJax.HTML.Element("mrow");mje.handleMover(),mrow.appendChild(MathJax.HTML.Element("mo"));var mrow1=MathJax.HTML.Element("mrow");mrow.appendChild(mrow1),mover.appendChild(mrow),mover.appendChild(MathJax.HTML.Element("mo",{},["⏜"])),mje.addElement(mover,mrow1)}},angleMeasure:{label:'<span style="font-weight:normal;"><span style="font-size: 80%; vertical-align: 20%">m</span>∠</span>',tooltip:"angle measure",fn:function(mje){var mrow=MathJax.HTML.Element("mrow")
;mrow.appendChild(MathJax.HTML.Element("mtext",{},["m"])),mrow.appendChild(MathJax.HTML.Element("mo",{},["∠"]));var mrow1=MathJax.HTML.Element("mrow");mrow.appendChild(mrow1),mje.tryExpression(),mje.addElement(mrow,mrow1)}},log:{label:"log",tooltip:"common logarithm",fn:function(mje){var mrow=MathJax.HTML.Element("mrow");mrow.appendChild(MathJax.HTML.Element("mi",{},["log"])),mrow.appendChild(MathJax.HTML.Element("mo"));var mrow1=MathJax.HTML.Element("mrow");mrow.appendChild(mrow1),mje.addElement(mrow,mrow1)}},logarithm:{label:'<span>log<span class="sub"><i>b</i></span></span>',tooltip:"general logarithm",fn:function(mje){
var mrow=MathJax.HTML.Element("mrow"),msub=MathJax.HTML.Element("msub");msub.appendChild(MathJax.HTML.Element("mi",{},["log"]));var mrow1=MathJax.HTML.Element("mrow");msub.appendChild(mrow1),mrow.appendChild(msub),mrow.appendChild(MathJax.HTML.Element("mo")),mrow.appendChild(MathJax.HTML.Element("mrow")),mje.addElement(mrow,mrow1)}},sin:{label:"sin",tooltip:"sine",fn:function(mje){var mrow=MathJax.HTML.Element("mrow");mrow.appendChild(MathJax.HTML.Element("mi",{},["sin"])),mrow.appendChild(MathJax.HTML.Element("mo"));var mrow1=MathJax.HTML.Element("mrow");mrow.appendChild(mrow1),mje.addElement(mrow,mrow1)}},cos:{label:"cos",tooltip:"cosine",fn:function(mje){
var mrow=MathJax.HTML.Element("mrow");mrow.appendChild(MathJax.HTML.Element("mi",{},["cos"])),mrow.appendChild(MathJax.HTML.Element("mo"));var mrow1=MathJax.HTML.Element("mrow");mrow.appendChild(mrow1),mje.addElement(mrow,mrow1)}},tan:{label:"tan",tooltip:"tangent",fn:function(mje){var mrow=MathJax.HTML.Element("mrow");mrow.appendChild(MathJax.HTML.Element("mi",{},["tan"])),mrow.appendChild(MathJax.HTML.Element("mo"));var mrow1=MathJax.HTML.Element("mrow");mrow.appendChild(mrow1),mje.addElement(mrow,mrow1)}},inverseSin:{label:'<span>sin<span class="sup">-1</span></span>',tooltip:"inverse sine",fn:function(mje){
var mrow=MathJax.HTML.Element("mrow"),msup=MathJax.HTML.Element("msup");mrow.appendChild(msup),msup.appendChild(MathJax.HTML.Element("mi",{},["sin"]));var mrow1=MathJax.HTML.Element("mrow");mrow1.appendChild(MathJax.HTML.Element("mo",{},["-"])),mrow1.appendChild(MathJax.HTML.Element("mn",{},["1"])),msup.appendChild(mrow1);var mrow2=MathJax.HTML.Element("mrow");mrow.appendChild(MathJax.HTML.Element("mo")),mrow.appendChild(mrow2),mje.addElement(mrow,mrow2)}},inverseCos:{label:'<span>cos<span class="sup">-1</span></span>',tooltip:"inverse cosine",fn:function(mje){var mrow=MathJax.HTML.Element("mrow"),msup=MathJax.HTML.Element("msup");mrow.appendChild(msup),
msup.appendChild(MathJax.HTML.Element("mi",{},["cos"]));var mrow1=MathJax.HTML.Element("mrow");mrow1.appendChild(MathJax.HTML.Element("mo",{},["-"])),mrow1.appendChild(MathJax.HTML.Element("mn",{},["1"])),msup.appendChild(mrow1);var mrow2=MathJax.HTML.Element("mrow");mrow.appendChild(MathJax.HTML.Element("mo")),mrow.appendChild(mrow2),mje.addElement(mrow,mrow2)}},inverseTan:{label:'<span>tan<span class="sup">-1</span></span>',tooltip:"inverse tangent",fn:function(mje){var mrow=MathJax.HTML.Element("mrow"),msup=MathJax.HTML.Element("msup");mrow.appendChild(msup),msup.appendChild(MathJax.HTML.Element("mi",{},["tan"]));var mrow1=MathJax.HTML.Element("mrow")
;mrow1.appendChild(MathJax.HTML.Element("mo",{},["-"])),mrow1.appendChild(MathJax.HTML.Element("mn",{},["1"])),msup.appendChild(mrow1);var mrow2=MathJax.HTML.Element("mrow");mrow.appendChild(MathJax.HTML.Element("mo")),mrow.appendChild(mrow2),mje.addElement(mrow,mrow2)}},secant:{label:"sec",tooltip:"secant",fn:function(mje){var mrow=MathJax.HTML.Element("mrow");mrow.appendChild(MathJax.HTML.Element("mi",{},["sec"])),mrow.appendChild(MathJax.HTML.Element("mo"));var mrow1=MathJax.HTML.Element("mrow");mrow.appendChild(mrow1),mje.addElement(mrow,mrow1)}},inverseSecant:{label:'<span>sec<span class="sup">-1</span></span>',tooltip:"inverse secant",fn:function(mje){
var mrow=MathJax.HTML.Element("mrow"),msup=MathJax.HTML.Element("msup");mrow.appendChild(msup),msup.appendChild(MathJax.HTML.Element("mi",{},["sec"]));var mrow1=MathJax.HTML.Element("mrow");mrow1.appendChild(MathJax.HTML.Element("mo",{},["-"])),mrow1.appendChild(MathJax.HTML.Element("mn",{},["1"])),msup.appendChild(mrow1);var mrow2=MathJax.HTML.Element("mrow");mrow.appendChild(MathJax.HTML.Element("mo")),mrow.appendChild(mrow2),mje.addElement(mrow,mrow2)}},cosecant:{label:"csc",tooltip:"cosecant",fn:function(mje){var mrow=MathJax.HTML.Element("mrow");mrow.appendChild(MathJax.HTML.Element("mi",{},["csc"])),mrow.appendChild(MathJax.HTML.Element("mo"))
;var mrow1=MathJax.HTML.Element("mrow");mrow.appendChild(mrow1),mje.addElement(mrow,mrow1)}},inverseCosecant:{label:'<span>csc<span class="sup">-1</span></span>',tooltip:"inverse cosecant",fn:function(mje){var mrow=MathJax.HTML.Element("mrow"),msup=MathJax.HTML.Element("msup");mrow.appendChild(msup),msup.appendChild(MathJax.HTML.Element("mi",{},["csc"]));var mrow1=MathJax.HTML.Element("mrow");mrow1.appendChild(MathJax.HTML.Element("mo",{},["-"])),mrow1.appendChild(MathJax.HTML.Element("mn",{},["1"])),msup.appendChild(mrow1);var mrow2=MathJax.HTML.Element("mrow");mrow.appendChild(MathJax.HTML.Element("mo")),mrow.appendChild(mrow2),mje.addElement(mrow,mrow2)}
},cotangent:{label:"cot",tooltip:"cotangent",fn:function(mje){var mrow=MathJax.HTML.Element("mrow");mrow.appendChild(MathJax.HTML.Element("mi",{},["cot"])),mrow.appendChild(MathJax.HTML.Element("mo"));var mrow1=MathJax.HTML.Element("mrow");mrow.appendChild(mrow1),mje.addElement(mrow,mrow1)}},inverseCotangent:{label:'<span>cot<span class="sup">-1</span></span>',tooltip:"inverse cotangent",fn:function(mje){var mrow=MathJax.HTML.Element("mrow"),msup=MathJax.HTML.Element("msup");mrow.appendChild(msup),msup.appendChild(MathJax.HTML.Element("mi",{},["cot"]));var mrow1=MathJax.HTML.Element("mrow");mrow1.appendChild(MathJax.HTML.Element("mo",{},["-"])),
mrow1.appendChild(MathJax.HTML.Element("mn",{},["1"])),msup.appendChild(mrow1);var mrow2=MathJax.HTML.Element("mrow");mrow.appendChild(MathJax.HTML.Element("mo")),mrow.appendChild(mrow2),mje.addElement(mrow,mrow2)}},factorial:{label:"<span><i>x</i>!</span>",tooltip:"factorial",fn:function(mje){var mrow=MathJax.HTML.Element("mrow"),mrow1=MathJax.HTML.Element("mrow");mrow.appendChild(mrow1),mrow.appendChild(MathJax.HTML.Element("mo",{},["!"])),mje.addElement(mrow,mrow1)}},overBar:{label:'<span><span style="display: inline-block; line-height: 0.6em; border-top: 1px solid; font-style: italic;">x</span></span>',tooltip:"sample mean x-bar",fn:function(mje){
var mover=MathJax.HTML.Element("mover");mover.setAttribute("selectable",!0),mover.appendChild(MathJax.HTML.Element("mi",{},["x"])),mover.appendChild(MathJax.HTML.Element("mo",{},["‾"])),mje.addElement(mover)}},overBarBlock:{label:'<span><span style="display: inline-block; line-height: 0.6em; border-top: 1px solid; font-style: italic;">y</span></span>',tooltip:"sample mean y-bar",fn:function(mje){var mover=MathJax.HTML.Element("mover");mover.setAttribute("selectable",!0),mover.appendChild(MathJax.HTML.Element("mi",{},["y"])),mover.appendChild(MathJax.HTML.Element("mo",{},["‾"])),mje.addElement(mover)}},superscript:{
label:'<span style="font-style:italic;">x<span class="sup">i</span></span>',tooltip:"superscript",fn:function(mje){mje.operator("^")}},prime:{label:"′",tooltip:"prime",fn:function(mje){var mo,node,msup=MathJax.HTML.Element("msup"),mrow=MathJax.HTML.Element("mrow"),nodes=mje.tryExpression();msup.appendChild(mrow),nodes.length?_.forEachRight(nodes,function(n){n.remove(),mrow.insertBefore(n,mrow.firstChild)}):(node=mje.getCurrentNode())&&"mtext"!==node.tagName.toLowerCase()&&(node.parentNode&&"mrow"===node.parentNode.tagName.toLowerCase()?nodes.push(node.parentNode):nodes.push(node),_.forEachRight(nodes,function(n){n.remove(),
mrow.insertBefore(n,mrow.firstChild)})),mo=MathJax.HTML.Element("mo",null,["'"]),msup.appendChild(mo),mje.addElement(msup)}}}}),define("nmcPci/portableLib/equationEditor/accordion/accordion",["jquery","lodash"],function($,_){"use strict";var panel="hr, .panel",ns="accordion",_toggleSections=function(sections,preserveOthers,state){sections.each(function(){$(this).find("h2").trigger("click",{preserveOthers:preserveOthers,forceState:state})})};return{init:function($sidebar){var $sections=$sidebar.find("section"),$allTriggers=($sidebar.children(panel).hide(),$sidebar.find("h2"));if(0===$allTriggers.length)return!0;$allTriggers.each(function(){
var $heading=$(this),$section=$heading.parents("section"),$panel=$section.children(panel),$closer=$("<span>",{class:"icon-up"}),$opener=$("<span>",{class:"icon-down"}),action=$panel.is(":visible")?"open":"close";$heading.append($closer).append($opener).addClass("closed"),$heading.hasClass("_accordion")||($heading.addClass("_accordion"),$panel.on("panelclose."+ns+" panelopen."+ns,function(e,args){var fn="panelclose"===e.type?"add":"remove";args.heading[fn+"Class"]("closed")}),$panel.trigger("panel"+action+"."+ns,{heading:$heading}))}),$sections.each(function(){$(this).find("h2").on("click",function(e,args){
var action,classFn,$heading=$(this),$panel=$heading.parents("section").children(panel),actions=(!args||args.preserveOthers,{close:"hide",open:"fadeIn"}),forceState=!(!args||!args.forceState)&&args.forceState;forceState&&(classFn="open"===forceState?"addClass":"removeClass",$heading[classFn]("closed")),action=$heading.hasClass("closed")?"open":"close",$panel.trigger("panel"+action+"."+ns,{heading:$heading})[actions[action]]()})})},closeSections:function(sections,preserveOthers){_toggleSections(sections,!!preserveOthers,"close")}}}),define("nmcEquationEditorInteraction/runtime/utils/mathMlUtils",["taoQtiItem/portableLib/jquery_2_1_1"],function($){
function visitMrow($mathMl){if($mathMl.children.length){var value=parse($mathMl.children[0]);return $mathMl.nextElementSibling&&(value+=parse($mathMl.nextElementSibling)),value}}function visitMn($mathMl){var value=$mathMl.innerHTML.match(/[\d.]/)?$mathMl.innerHTML:"";return $mathMl.nextElementSibling&&(value+=parse($mathMl.nextElementSibling)),value}function visitMo($mathMl){if("."===$mathMl.innerHTML||"-"===$mathMl.innerHTML){var value=$mathMl.innerHTML;return $mathMl.nextElementSibling&&(value+=parse($mathMl.nextElementSibling)),value}}function visitFrac($mathMl){if(2===$mathMl.children.length){var numerator,denominator,value
;return $mathMl.children[0].children.length&&(numerator=parse($mathMl.children[0].children[0])),$mathMl.children[1].children.length&&(denominator=parse($mathMl.children[1].children[0])),value=(Number.parseFloat(numerator)/Number.parseFloat(denominator)).toString(),"0"===value[0]&&(value=value.substring(1)),value}}function parse($mathMl){switch($mathMl.tagName.toLowerCase()){case"mn":return visitMn($mathMl);case"mo":return visitMo($mathMl);case"mfrac":return visitFrac($mathMl);case"mrow":return visitMrow($mathMl)}}function parseFloat(mathMl){if(mathMl){var $mathMl=$(mathMl);if($mathMl.length){var value=parse($mathMl[0]);return Number.parseFloat(value)}}
return NaN}return{parseFloat:parseFloat}}),function(e){function f(a,c){function b(a){if(!this||this.constructor!==b)return new b(a);this._keys=[],this._values=[],this._itp=[],this.objectOnly=c,a&&v.call(this,a)}return c||w(a,"size",{get:x}),a.constructor=b,b.prototype=a,b}function v(a){this.add?a.forEach(this.add,this):a.forEach(function(a){this.set(a[0],a[1])},this)}function d(a){return this.has(a)&&(this._keys.splice(b,1),this._values.splice(b,1),this._itp.forEach(function(a){b<a[0]&&a[0]--})),-1<b}function m(a){return this.has(a)?this._values[b]:void 0}function n(a,c){
if(this.objectOnly&&c!==Object(c))throw new TypeError("Invalid value used as weak collection key");if(c!=c||0===c)for(b=a.length;b--&&!y(a[b],c););else b=a.indexOf(c);return-1<b}function p(a){return n.call(this,this._values,a)}function q(a){return n.call(this,this._keys,a)}function r(a,c){return this.has(a)?this._values[b]=c:this._values[this._keys.push(a)-1]=c,this}function t(a){return this.has(a)||this._values.push(a),this}function h(){(this._keys||0).length=this._values.length=0}function z(){return k(this._itp,this._keys)}function l(){return k(this._itp,this._values)}function A(){return k(this._itp,this._keys,this._values)}function B(){
return k(this._itp,this._values,this._values)}function k(a,c,b){var g=[0],e=!1;return a.push(g),{next:function(){var f,d=g[0];return!e&&d<c.length?(f=b?[c[d],b[d]]:c[d],g[0]++):(e=!0,a.splice(a.indexOf(g),1)),{done:e,value:f}}}}function x(){return this._values.length}function u(a,c){for(var b=this.entries();;){var d=b.next();if(d.done)break;a.call(c,d.value[1],d.value[0],this)}}var b,w=Object.defineProperty,y=function(a,b){return isNaN(a)?isNaN(b):a===b};"undefined"==typeof WeakMap&&(e.WeakMap=f({delete:d,clear:h,get:m,has:q,set:r},!0)),"undefined"!=typeof Map&&"function"==typeof(new Map).values&&(new Map).values().next||(e.Map=f({delete:d,has:q,get:m,set:r,
keys:z,values:l,entries:A,forEach:u,clear:h})),"undefined"!=typeof Set&&"function"==typeof(new Set).values&&(new Set).values().next||(e.Set=f({has:p,add:t,delete:d,clear:h,keys:l,values:l,entries:B,forEach:u})),"undefined"==typeof WeakSet&&(e.WeakSet=f({delete:d,add:t,clear:h,has:p},!0))}("undefined"!=typeof exports&&"undefined"!=typeof global?global:window),define("nmcPci/portableLib/equationEditor/polyfill/es6-collections",function(){}),
define("nmcEquationEditorInteraction/runtime/nmcEquationEditorInteraction",["qtiCustomInteractionContext","taoQtiItem/portableLib/jquery_2_1_1","taoQtiItem/portableLib/lodash","taoQtiItem/portableLib/OAT/util/event","nmcPci/portableLib/equationEditor/mathJaxEditor/editor","nmcPci/portableLib/equationEditor/tools/grade","nmcPci/portableLib/equationEditor/tools/keyboardBehavior","nmcPci/portableLib/equationEditor/tools/numbersAndFraction","nmcPci/portableLib/equationEditor/tools/numbersAndMath","nmcPci/portableLib/equationEditor/tools/numbersMathAndText","nmcPci/portableLib/equationEditor/tools/availableTools","nmcPci/portableLib/equationEditor/accordion/accordion","nmcEquationEditorInteraction/runtime/utils/mathMlUtils","taoQtiItem/qtiCommonRenderer/renderers/Math","nmcPci/portableLib/equationEditor/polyfill/es6-collections"],function(qtiCustomInteractionContext,$,_,event,editor,grade,keyboardBehavior,numbersAndFraction,numbersAndMath,numbersMathAndText,tools,accordion,mathMlUtils){
"use strict";var ns=".nmcEquationEditorInteraction",equationEditorInteraction={inQtiCreator:function(){return _.isUndefined(this._inQtiCreator)&&this.$container&&(this._inQtiCreator=this.$container.hasClass("tao-qti-creator-context")),this._inQtiCreator},addGap:function(){var mrow=MathJax.HTML.Element("mrow",{editable:!0});mrow.classList.add("ee-gap"),this.mje.addElement(mrow,mrow),this.mje.focus()},toolBarClick:function(tool,value){tool.fn(this.mje,value),this.mje.focus()},render:function(config){var $entry,$container,$toolbar;this.initConfig(config),$entry=this.$container.find(".math-entry"),$container=this.$container.find(".editor-container"),
$toolbar=this.$container.find(".toolbar-container"),$container.height(parseInt(this.config.height,10)||"auto"),this.config.keyboardBehavior===keyboardBehavior.numbersMathAndText?$toolbar.height(parseInt(this.config.height,10)||"auto"):$toolbar.height("auto"),$entry.width(this.config.width),$entry.removeClass(function(index,className){return(className.match(/(^|\s)kb-\S+/g)||[]).join(" ")}),$entry.removeClass(function(index,className){return(className.match(/(^|\s)grade-\S+/g)||[]).join(" ")}),$entry.addClass("kb"+this.config.keyboardBehavior.replace(/([A-Z])/g,"-$1").toLowerCase()),
$entry.addClass("grade-"+this.config.gradeLevel.replace(/([A-Z])/g,"-$1").toLowerCase()),this.setEditorOptions(),this.createToolbar(),this.addToolbarListeners()},initConfig:function(config){function toBoolean(value,defaultValue){return void 0===value?defaultValue:!0===value||"true"===value}this.config={toolGroups:{mathsymbols:toBoolean(config.mathsymbols,!0),symbols:toBoolean(config.symbols,!0),geometry:toBoolean(config.geometry,!0),groups:toBoolean(config.groups,!0),relations:toBoolean(config.relations,!0),greek:toBoolean(config.greek,!0),trigonometry:toBoolean(config.trigonometry,!0),statistics:toBoolean(config.statistics,!0)},
allowNewLine:toBoolean(config.allowNewLine,!1),useGapExpression:toBoolean(config.useGapExpression,!1),width:parseInt(config.width,10)||960,height:parseInt(config.height,10)||"auto",expression:config.expression,gradeLevel:config.gradeLevel||grade.grade_9_12,keyboardBehavior:config.keyboardBehavior||keyboardBehavior.numbersAndFraction}},setEditorOptions:function(){this.mje&&(this.mje.allowNewline(this.config.allowNewLine),this.mje.allowText(this.config.keyboardBehavior===keyboardBehavior.numbersMathAndText))},createMathEditable:function(){var $mje=$("<div>"),self=this;this.$editor.empty(),this.$editor.append($mje),this.mje=editor.default($mje[0]),
this.inQtiCreator()&&(this.mje.onChange=function(math){self.trigger("responseChange",[self.mje.get()])}),this.setEditorOptions(),this.inQtiCreator()||this.mje.readonly(this.config.useGapExpression),this.config.expression&&self.mje.set(self.config.expression),this.$clearButton.on("click",function(){var expression="<math></math>";!self.inQtiCreator()&&self.config.expression&&(expression=self.config.expression),self.mje.set(expression),self.inQtiCreator()&&self.trigger("responseChange",[expression]),self.mje.focus()}),this.$undoButton.on("click",function(){self.mje.undo(),self.mje.focus()}),this.$redoButton.on("click",function(){self.mje.redo(),self.mje.focus()
})},createToolbar:function(){switch(this.$toolbar.empty(),this.config.keyboardBehavior){case keyboardBehavior.numbersAndFraction:this.createTools(numbersAndFraction);break;case keyboardBehavior.numbersAndMath:this.createTools(numbersAndMath[this.config.gradeLevel]||numbersAndMath[grade.grade_9_12]);break;case keyboardBehavior.numbersMathAndText:this.createToolGroups(numbersMathAndText[this.config.gradeLevel]||numbersMathAndText[grade.grade_9_12])}},createTools:function(tools){var self=this,$tools=$("<div>",{class:"item-editor-sidebar"});tools.forEach(function(tool,idx){$tools.append(self.createTool(tool,idx))}),self.$toolbar.append($tools)},
createToolGroups:function(groups){var self=this,$accordion=$("<div>",{class:"item-editor-sidebar"});self.activeTools=[],groups.forEach(function(toolgroup){$accordion.append(self.createToolGroup(toolgroup))}),accordion.init($accordion),accordion.closeSections($accordion.find("section")),self.$toolbar.append($accordion)},createToolGroup:function(group){var self=this,$toolGroup=$("<section>",{class:"tool-group","data-identifier":group.id});$toolGroup.append($("<h2>",{html:group.title}));var $panel=$("<div>",{class:"panel"});return $toolGroup.append($panel),group.tools.forEach(function(tool,idx){$panel.append(self.createTool(tool,idx))}),$toolGroup},
createTool:function(tool){var label,toolType,value,title;return"string"==typeof tool?(label=tools[tool].icon?'<span><i class="icon-'+tools[tool].icon+'"></i></span>':0===tools[tool].label.indexOf("<span>")?tools[tool].label:"<span>"+tools[tool].label+"</span>",value=null,toolType=tool,title=tools[tool].tooltip):(label=0===tool.value.indexOf("<span>")?tool.value:"<span>"+tool.value+"</span>",value=tool.value,toolType=tool.toolType,title=tool.tooltip),$("<button>",{class:"math-entry-tool","data-identifier":toolType,"data-value":value,"data-tooltip":title,html:label})},addToolbarListeners:function(){var self=this
;this.$toolbar.find(".math-entry-tool").off("click"+ns).on("click"+ns,function(e){var $target=$(e.currentTarget),id=$target.data("identifier"),value=$target.data("value");e.stopPropagation(),e.preventDefault(),tools[id].fn(self.mje,value),self.mje.focus()})},id:-1,getTypeIdentifier:function(){return"nmcEquationEditorInteraction"},initialize:function(id,dom,config){var self=this;event.addEventMgr(this),this.id=id,this.dom=dom,this.$container=$(dom),this.$mathEntry=this.$container.find("math-entry"),this.$toolbarContainer=this.$container.find(".toolbar-container"),this.$toolbar=this.$container.find(".toolbar"),
this.$moreLessButton=this.$container.find(".more-less-button"),this.$editor=this.$container.find(".mje-editor"),this.$clearButton=this.$container.find(".clear-button"),this.$undoButton=this.$container.find(".undo-button"),this.$redoButton=this.$container.find(".redo-button"),this.activeTools=[],this.render(config),this.createMathEditable(),this.on("configChange",function(newConfig){self.render(newConfig)}),this.on("questionToolbarClick",function(tool,value){self.toolBarClick(tool,value)}),this.on("addGap",function(){self.addGap()}),this.$moreLessButton.on("click",function(){self.$toolbarContainer.toggleClass("show-less")}),
qtiCustomInteractionContext.notifyReady(this)},setResponse:function(response){},getResponse:function(){var response,rawData=this.mje.get();if(this.config.useGapExpression){response={record:$(rawData).find("mrow[editable=true]").toArray().map(function(gap,idx){return{name:"gap_"+idx+"_value",base:{float:mathMlUtils.parseFloat(gap.innerHTML)}}},{})}}else response={base:{string:rawData}};return response},resetResponse:function(){},destroy:function(){},setSerializedState:function(state){},getSerializedState:function(){return{response:this.getResponse()}}};qtiCustomInteractionContext.register(equationEditorInteraction)}),
define(["nmcEquationEditorInteraction/runtime/nmcEquationEditorInteraction"],function(PCI){return PCI});
//# sourceMappingURL=nmcEquationEditorInteraction.min.js.map